                    ...
                    _OutRange&& __out_r, _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    auto [it1, it2, it3] = __par_backend_hetero::__parallel_set_op<unseq_backend::_UnionTag>(
                           ...
                           _OutRange&& __out_r, _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    auto [it1, it2, it3] = __par_backend_hetero::__parallel_set_op<unseq_backend::_IntersectionTag>(
                         ...
                         _OutRange&& __out_r, _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    auto [it1, it2, it3] = __par_backend_hetero::__parallel_set_op<unseq_backend::_DifferenceTag>(
                                   ...
                                   _OutRange&& __out_r, _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    auto [it1, it2, it3] = __par_backend_hetero::__parallel_set_op<unseq_backend::_SymmetricDifferenceTag>(

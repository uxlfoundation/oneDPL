                   ...
                   _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    using __brick_include_type =
        unseq_backend::__brick_includes<decltype(__comp), decltype(__n2), decltype(__n1), _Proj1, _Proj2>;
    using _TagType = __par_backend_hetero::__parallel_or_tag;
    using __size_calc = oneapi::dpl::__ranges::__first_size_calc;

    return !oneapi::dpl::__par_backend_hetero::__parallel_find_or(
        _BackendTag{}, std::forward<_ExecutionPolicy>(__exec),
        __brick_include_type{__comp, __n2, __n1, __proj1, __proj2}, _TagType{}, __size_calc{},

...
__pattern_walk_n(__hetero_tag<_BackendTag>, _ExecutionPolicy&& __exec, _Function __f, _Ranges&&... __rngs)
{
    ...
    if (__n > 0)
    {
        ...
        else if constexpr (__num_ranges == 2)
        {
            oneapi::dpl::__par_backend_hetero::__parallel_for(
                _BackendTag{}, std::forward<_ExecutionPolicy>(__exec),
                unseq_backend::walk2_vectors_or_scalars<std::decay_t<_ExecutionPolicy>, _Function, std::decay_t<_Ranges>...>{
                    __f, static_cast<std::size_t>(__n)},
                __n, std::forward<_Ranges>(__rngs)...)
                .__deferrable_wait();
        }
        else
        {
            oneapi::dpl::__par_backend_hetero::__parallel_for(
                _BackendTag{}, std::forward<_ExecutionPolicy>(__exec),
                unseq_backend::walk3_vectors_or_scalars<std::decay_t<_ExecutionPolicy>, _Function, std::decay_t<_Ranges>...>{
                    __f, static_cast<std::size_t>(__n)},
                __n, std::forward<_Ranges>(__rngs)...)
                .__deferrable_wait();
        }
...
struct __pattern_for_each_fn
{
    ...
    void operator()(auto&& __val)
    {
        std::invoke(__f, std::invoke(__proj, std::forward<decltype(__val)>(__val)));
    }
};
...
struct __pattern_transform_unary_op
{
    ...
    auto
    operator()(auto&& __val) -> decltype(std::invoke(__op, std::invoke(__proj, std::forward<decltype(__val)>(__val))))
    {
...
struct __pattern_transform_fn
{
    ...
    auto
    operator()(auto&& __val1, auto&& __val2)
        -> decltype(std::invoke(__binary_op, std::invoke(__proj1, std::forward<decltype(__val1)>(__val1)),
...
__pattern_equal(__hetero_tag<_BackendTag>, _ExecutionPolicy&& __exec, _Range1&& __rng1, _Range2&& __rng2, _Pred __pred)
{
    ...
    using _Predicate =
        oneapi::dpl::unseq_backend::single_match_pred<std::decay_t<_ExecutionPolicy>, equal_predicate<_Pred>>;
...
struct __pattern_equal_pred
{
    ...
    auto
    operator()(auto&& __val1, auto&& __val2)
        -> decltype(std::invoke(__pred, std::invoke(__proj1, std::forward<decltype(__val1)>(__val1)),
                                std::invoke(__proj2, std::forward<decltype(__val2)>(__val2))))
    {
...
__pattern_find_if(__hetero_tag<_BackendTag>, _ExecutionPolicy&& __exec, _Range&& __rng, _Pred __pred)
{
    ...
    using _Predicate = oneapi::dpl::unseq_backend::single_match_pred<std::decay_t<_ExecutionPolicy>, _Pred>;
...
struct __pattern_find_if_pred
{
    ...
    auto
    operator()(auto&& __val) -> decltype(std::invoke(__pred, std::invoke(__proj, std::forward<decltype(__val)>(__val))))
    {
...
struct __pattern_search_n_fn
{
    ...
    const _Tp& operator()(auto) const { return __value; }
};
...
struct __pattern_search_n_pred
{
    ...
    auto
    operator()(auto&& __val1, auto&& __val2)
        -> declval(std::invoke(__pred, std::invoke(__proj, std::forward<decltype(__val1)>(__val1)),
                        ...
                        _BinaryPredicate __predicate, _OrFirstTag __is__or_semantic)
{
    ...
    using _Predicate = oneapi::dpl::unseq_backend::single_match_pred<std::decay_t<_ExecutionPolicy>,
                                                                     adjacent_find_fn<_BinaryPredicate>>;
...
struct __pattern_adjacent_find_ranges_pred
{
    ...
    auto
    operator()(auto&& __val, auto&& __next)
        -> declval(std::invoke(__pred, std::invoke(__proj, std::forward<decltype(__val)>(__val)),
...
struct __pattern_is_sorted_pred
{
    ...
    auto
    operator()(auto&& __val1, auto&& __val2)
        -> declval(std::invoke(__comp, std::invoke(__proj, std::forward<decltype(__val1)>(__val1)),
                               std::invoke(__proj, std::forward<decltype(__val2)>(__val2))))
    {
        return std::invoke(__comp, std::invoke(__proj, std::forward<decltype(__val1)>(__val1)),
                           std::invoke(__proj, std::forward<decltype(__val2)>(__val2)));
    }
};
...
struct __pattern_count_transform_fn
{
    ...
    int operator()(auto __gidx, auto __acc)
    {
...
struct __pattern_count_if_pred
{
    ...
    auto operator()(auto&& __val) -> decltype(std::invoke(__pred, std::invoke(__proj, std::forward<decltype(__val)>(__val)))
    {
        return std::invoke(__pred, std::invoke(__proj, std::forward<decltype(__val)>(__val)));
    }
};
...
struct __pattern_copy_if_ranges_pred
{
    ...
    auto
    operator()(auto&& __val) -> declval(std::invoke(__pred, std::invoke(__proj, std::forward<decltype(__val)>(__val))))
    {
        return std::invoke(__pred, std::invoke(__proj, std::forward<decltype(__val)>(__val)));
    }
};
    ...
    if (__n == 1)
    {
        ...
        oneapi::dpl::__par_backend_hetero::__parallel_for(
            ...
            oneapi::dpl::__par_backend_hetero::make_wrapped_policy<__copy_wrapper>(
                std::forward<_ExecutionPolicy>(__exec)),
            unseq_backend::walk2_vectors_or_scalars<std::decay_t<_ExecutionPolicy>, _CopyBrick, std::decay_t<_Range1>,
...
struct __pattern_merge_comp
{
    ...
    auto
    operator()(auto&& __val1, auto&& __val2)
        -> declval(std::invoke(__comp, std::invoke(__proj1, std::forward<decltype(__val1)>(__val1)),
                               std::invoke(__proj2, std::forward<decltype(__val2)>(__val2))))
    {
        return std::invoke(__comp, std::invoke(__proj1, std::forward<decltype(__val1)>(__val1)),
                           std::invoke(__proj2, std::forward<decltype(__val2)>(__val2)));
    }
};
...
struct __pattern_min_element_reduce_fn
{
    ...
    _ReduceValueType
    operator()(_ReduceValueType __a, _ReduceValueType __b)
    {
        using ::std::get;
...
{
    _ReduceValueType
    operator()(auto __gidx, auto __acc) const
    {

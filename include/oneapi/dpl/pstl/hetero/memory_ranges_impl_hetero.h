                             ...
                             _OutRange&& __out_r)
{
                  ...
                  std::is_trivially_assignable_v<_OutRefType, _InRefType>)
    {
        oneapi::dpl::__internal::__ranges::__pattern_walk_n(
            ...
            oneapi::dpl::__ranges::views::all_read(oneapi::dpl::__ranges::take_view_simple(std::forward<_InRange>(__in_r), __n_min)),
            oneapi::dpl::__ranges::views::all_write(oneapi::dpl::__ranges::take_view_simple(std::forward<_OutRange>(__out_r), __n_min)));
    }
    else
    {
        oneapi::dpl::__internal::__ranges::__pattern_walk_n(

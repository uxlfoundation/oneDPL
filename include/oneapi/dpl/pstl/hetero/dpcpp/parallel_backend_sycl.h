...
struct __gen_set_balanced_path
{
    ...
    operator()(const _InRng& __in_rng, _IndexT __id) const
    {
        ...
        auto [__rng1_pos, __rng2_pos] = oneapi::dpl::__par_backend_hetero::__find_start_point(__rng1, _SizeType{0},
                                                                                              __rng1.size(),
                                                                                              __rng2, _SizeType{0},
                                                                                              __rng2.size(),
                                                                                              __i_elem, __comp);
    ...
    if constexpr (std::is_trivially_copyable_v<_Type>)
    {
        ...
        if (__use_reduce_then_scan)
        {
            ...
            return __parallel_transform_reduce_then_scan(
                __backend_tag, std::forward<_ExecutionPolicy>(__exec), __in_rng.size(), std::forward<_Range1>(__in_rng),
                                              ...
                                              _BinaryPredicate __binary_pred, _BinaryOperator __binary_op)
{
    ...
    assert(__n > 1);
    return __parallel_transform_reduce_then_scan(
        __backend_tag, std::forward<_ExecutionPolicy>(__exec), __keys.size(),
                                ...
                                _SetTag)
{
    ...
    oneapi::dpl::__par_backend_hetero::__buffer<_ExecutionPolicy, std::int32_t> __temp_diags1(__exec, __num_diagonals);
    oneapi::dpl::__par_backend_hetero::__buffer<_ExecutionPolicy, std::int32_t> __temp_diags2(__exec, __num_diagonals);
    oneapi::dpl::__par_backend_hetero::__buffer<_ExecutionPolicy, bool> __temp_star(__exec, __num_diagonals);

...
struct __parallel_copy_if_single_group_submitter<_Size, __internal::__optional_kernel_name<_ScanKernelName...>>
{
               ...
               _UnaryOp __unary_op, _Assign __assign, std::uint16_t __n_uniform, std::uint16_t __wg_size)
    {
        ...
        __q.submit([&](sycl::handler& __hdl) {
            ...
            auto __res_acc = __result.template __get_accessor<sycl::access_mode::write>(__hdl, __dpl_sycl::__no_init{});
                          ...
                          _BinaryOperation __binary_op, _Inclusive)
{
    ...
    return __future(__event, __result_and_scratch_storage<_Type>(__transfer_state_from(__payload)));
}
                       ...
                       _Range2&& __result, _BinaryPredicate __pred)
{
    ...
    else
    {
        ...
        return __future(__event, __result_and_scratch_storage<_Size1>(__transfer_state_from(__payload)));
    }
}

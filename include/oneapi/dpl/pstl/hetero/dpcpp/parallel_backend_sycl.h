                       ...
                       _Range2&& __result, _Size __n, _Size __n_out, _BinaryPredicate __pred)
{
    ...
    else if (oneapi::dpl::__par_backend_hetero::__is_gpu_with_reduce_then_scan_sg_sz(__q_local))
    {
        ...
        auto&& [__event, __stop_pos, __oob_pos] = __parallel_reduce_then_scan_copy</*_Bounded*/ true, _CustomName>(
        ...
        __stop_pos.__copy_result(__ret.data(), 1);
        __ret[1] = __get_finish_pos(__oob_pos, __n);
    }
    else
    {

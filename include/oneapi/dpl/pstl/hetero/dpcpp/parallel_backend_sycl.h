...
struct __parallel_scan_submitter<_CustomName, __internal::__optional_kernel_name<_PropagateScanName...>>
{
               ...
               _LocalScan __local_scan, _GroupScan __group_scan, _GlobalScan __global_scan) const
    {
        ...
        // because we always specialize this __parallel_scan_submitter::operator() calls only by _ExecutionPolicy as "const reference".
                          ...
                          _InitType __init, _BinaryOperation __binary_op, _Inclusive)
{
    ...
    return __parallel_transform_scan_base(
        ...
        // local scan
        unseq_backend::__scan<_Inclusive, std::decay_t<_ExecutionPolicy>, _BinaryOperation, _UnaryFunctor, _Assigner,
                              _Assigner, _NoOpFunctor, _InitType>{__binary_op, _UnaryFunctor{__unary_op}, __assign_op,
                                                                  __assign_op, __get_data_op},
        // scan between groups
        unseq_backend::__scan</*inclusive=*/std::true_type, std::decay_t<_ExecutionPolicy>, _BinaryOperation,
                              _NoOpFunctor, _NoAssign, _Assigner, _NoOpFunctor, unseq_backend::__no_init_value<_Type>>{
                     ...
                     _CopyByMaskOp __copy_by_mask_op)
{
    ...
    return __parallel_transform_scan_base(
        ...
        // local scan
        unseq_backend::__scan</*inclusive*/ std::true_type, std::decay_t<_ExecutionPolicy>, _ReduceOp, _DataAcc,
                              _Assigner, _MaskAssigner, _CreateMaskOp, _InitType>{
            __reduce_op, __get_data_op, __assign_op, __add_mask_op, __create_mask_op},
        // scan between groups
        unseq_backend::__scan</*inclusive*/ std::true_type, std::decay_t<_ExecutionPolicy>, _ReduceOp, _DataAcc,
                              _NoAssign, _Assigner, _DataAcc, _InitType>{__reduce_op, __get_data_op, _NoAssign{},
                                                                         __assign_op, __get_data_op},
        // global scan
        __copy_by_mask_op);
}
                    ...
                    _Range1&& __rng1, _Range2&& __rng2, _Range3&& __result, _Compare __comp, _IsOpDifference)
{
    ...
    return __par_backend_hetero::__parallel_transform_scan_base(
        ...
        // local scan
        unseq_backend::__scan</*inclusive*/ std::true_type, std::decay_t<_ExecutionPolicy>, _ReduceOp, _DataAcc,
                              _Assigner, _MaskAssigner, decltype(__create_mask_op), _InitType>{
                   ...
                   _BrickTag __brick_tag, _Ranges&&... __rngs)
{
    ...
    const auto __pred = oneapi::dpl::__par_backend_hetero::__early_exit_find_or<std::decay_t<_ExecutionPolicy>, _Brick>{__f};
    ...
    if (__n_groups == 1)
    {
        ...
        using __find_or_one_wg_kernel_name =
            oneapi::dpl::__par_backend_hetero::__internal::__kernel_name_provider<__find_or_kernel_one_wg<_CustomName, _Brick, _BrickTag, _Ranges...>>;

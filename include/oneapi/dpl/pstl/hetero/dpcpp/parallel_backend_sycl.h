...
std::conditional_t<
    _Bounded,
    std::tuple<sycl::event, __combined_storage<typename _InitType::__value_type>, std::vector<__scan_stop_pos_storage_t<_Range1>>>,
    std::tuple<sycl::event, __combined_storage<typename _InitType::__value_type>>
>
...
std::conditional_t<
    _Bounded,
    std::tuple<sycl::event, __combined_storage<_Size>, std::vector<__scan_stop_pos_storage_t<_InRng>>>,
...
std::conditional_t<
    _Bounded,
    std::tuple<sycl::event, __combined_storage<oneapi::dpl::__internal::tuple<std::size_t, oneapi::dpl::__internal::__value_t<_Range2>>>, std::vector<__scan_stop_pos_storage_t<_Range1, _Range2>>>,
...
std::conditional_t<
    _Bounded,
    std::tuple<sycl::event, __combined_storage<oneapi::dpl::__internal::__difference_t<_Range1>>, std::vector<__scan_stop_pos_storage_t<_Range1>>>,
                          ...
                          _Range2&& __result, _UnaryPredicate __pred)
{
    ...
    if (oneapi::dpl::__par_backend_hetero::__is_gpu_with_reduce_then_scan_sg_sz(__q_local))
    {
        ...
        return __parallel_reduce_then_scan_copy<_Bounded, _CustomName>(
                            ...
                            _Compare __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    _BoundsProviderPhase1 __bounds_provider_phase1{__diagonal_spacing, __partition_size, __partition_threshold};
    _BoundsProviderPhase2 __bounds_provider_phase2{__diagonal_spacing, __partition_size, __partition_threshold};
    _GenReduceInputPhase1 __gen_reduce_input_phase1{_SetOperation{}, __diagonal_spacing, __bounds_provider_phase1, __comp, __proj1, __proj2};
    _GenReduceInputPhase2 __gen_reduce_input_phase2{_SetOperation{}, __diagonal_spacing, __bounds_provider_phase2, __comp, __proj1, __proj2};
    ...
    if (__total_size >= __partition_threshold)
        __partition_event = __parallel_set_balanced_path_partition<_CustomName>(__q, std::move(__in_in_tmp_rng_phase1), __num_diagonals, __gen_reduce_input_phase1);
...
std::conditional_t<
    _Bounded,
    std::tuple<sycl::event, __combined_storage<oneapi::dpl::__internal::tuple<std::uint32_t, oneapi::dpl::__internal::__value_t<_Range2>>>, std::vector<__scan_stop_pos_storage_t<_Range1, _Range2>>>,

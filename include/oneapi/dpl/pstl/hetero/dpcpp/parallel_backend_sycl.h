...
struct __parallel_reduce_by_segment_fallback_fn1_fo
{
    ...
    bool operator()(const auto& __a) const
    {
                                      ...
                                      /*known_identity=*/std::false_type)
{
    ...
    auto __intermediate_result_end =
        oneapi::dpl::__par_backend_hetero::__parallel_copy_if(
            ...
            __n,
            __parallel_reduce_by_segment_fallback_fn1_fo<_BinaryOperator>{__binary_pred, __wgroup_size}, // KSATODO moved out
    ...
    auto __result_end = oneapi::dpl::__par_backend_hetero::__parallel_copy_if(
                            ...
                            __parallel_reduce_by_segment_fallback_fn2_fo<_BinaryOperator>{__binary_pred}, // KSATODO moved out
                            unseq_backend::__brick_assign_key_position{})
                            .get();

...
std::tuple<__hetero_event<oneapi::dpl::__internal::__device_backend_tag>,
           __combined_storage<typename _InitType::__value_type>>
    ...
    if constexpr (std::is_trivially_copyable_v<_Type>)
    {
        ...
        if constexpr (unseq_backend::__can_use_group_reduce_scan<_BinaryOperation, _Type>::value)
        {
            ...
            if (__group_scan_fits_in_slm<_Type>(__q_local, __n, __n_uniform, __single_group_upper_limit))
            {
                ...
                return {std::move(__event), __combined_storage<_Type>()};
            }
        }
    }
                                      ...
                                      /*__can_use_group_reduce_scan*/ std::false_type)
{
    ...
    //reduce by segment
    oneapi::dpl::__par_backend_hetero::__hetero_event<oneapi::dpl::__internal::__device_backend_tag> __event =
    ...
    //reduce by segment
    oneapi::dpl::__par_backend_hetero::__hetero_event<oneapi::dpl::__internal::__device_backend_tag> __event2 =
        oneapi::dpl::__par_backend_hetero::__parallel_for(
            oneapi::dpl::__internal::__device_backend_tag{},
    ...
    oneapi::dpl::__par_backend_hetero::__finalize_call<__deferrable_mode>(__event2);
                             ...
                             _BinaryPredicate __binary_pred, _BinaryOperator __binary_op)
{
    ...
    return std::get<0>(__load_result(std::get<1>(__res))) + 1;
#else
    using __val_type = oneapi::dpl::__internal::__value_t<_Range2>;

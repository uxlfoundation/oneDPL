    ...
    if constexpr (std::is_trivially_copyable_v<_Type>)
    {
        ...
        if (__use_reduce_then_scan)
        {
            ...
            return __parallel_transform_reduce_then_scan<sizeof(typename _InitType::__value_type), _CustomName>(
                __q_local, __in_rng.size(), std::forward<_Range1>(__in_rng),
                                 ...
                                 _GenMask __generate_mask, _WriteOp __write_op, _IsUniquePattern __is_unique_pattern)
{
    ...
    return __parallel_transform_reduce_then_scan<sizeof(_Size), _CustomName>(
        __q, __in_rng.size(), std::forward<_InRng>(__in_rng), std::forward<_OutRng>(__out_rng),
...
template <typename _ExecutionPolicy, typename _Range1, typename _Range2, typename _Range3, typename _Compare,
          typename _SetTag>
__future<sycl::event, __result_and_scratch_storage<oneapi::dpl::__internal::__difference_t<_Range3>>>
__parallel_set_op(_ExecutionPolicy&& __exec,
...
__parallel_reduce_by_segment_fallback(oneapi::dpl::__internal::__device_backend_tag __backend_tag,
                                      ...
                                      /*known_identity=*/std::false_type)
{
    ...
    auto __intermediate_result_end =
        oneapi::dpl::__par_backend_hetero::__parallel_copy_if(
            __backend_tag, oneapi::dpl::__par_backend_hetero::make_wrapped_policy<__assign_key1_wrapper>(__exec),
            __view1, __view2, __n,
    ...
    oneapi::dpl::__par_backend_hetero::__parallel_for(
        __backend_tag, oneapi::dpl::__par_backend_hetero::make_wrapped_policy<__reduce1_wrapper>(__exec),
    ...
    auto __result_end =
        oneapi::dpl::__par_backend_hetero::__parallel_copy_if(
            __backend_tag, oneapi::dpl::__par_backend_hetero::make_wrapped_policy<__assign_key2_wrapper>(__exec),
                             ...
                             _BinaryPredicate __binary_pred, _BinaryOperator __binary_op)
{
    ...
    return __parallel_reduce_by_segment_fallback(
        __backend_tag, std::forward<_ExecutionPolicy>(__exec), std::forward<_Range1>(__keys),

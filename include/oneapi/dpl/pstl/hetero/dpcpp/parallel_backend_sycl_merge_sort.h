                                     ...
                                     __internal::__optional_kernel_name<_GlobalSortName2...>>
{
  ...
  public:
               ...
               sycl::event __event_chain) const
    {
        ...
        // shared_ptr instance to return it in __event_with_keepalive and extend the lifetime of the storage.
        ...
        for (std::int64_t __i = 0; __i < __n_iter; ++__i)
        {
            ...
            else
            {
                if (nullptr == __p_base_diagonals_sp_global_storage)
                {
                    ...
                    // Save the raw pointer into a shared_ptr to return it in __event_with_keepalive and extend the lifetime of the storage.
...
__merge_sort(sycl::queue& __q, _Range&& __rng, _Compare __comp, _LeafSorter& __leaf_sorter)
{
    ...
    return __event_with_keepalive{std::move(__event_sort), std::move(__temp_sp_storages)};
}

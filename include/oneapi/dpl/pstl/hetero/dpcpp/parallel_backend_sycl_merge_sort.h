...
#include "parallel_backend_sycl_merge.h" // __find_merge_path_start_point, __serial_merge
...
struct __group_merge_path_sorter
{
         ...
         std::uint32_t __workgroup_size) const
    {
        ...
        for (std::int16_t __i = 0; __i < __iters; ++__i)
        {
            ...
            const auto __start = __find_merge_path_start_point(__in_ptr1, __in_ptr2, __id_local, __n1, __n2, __comp);

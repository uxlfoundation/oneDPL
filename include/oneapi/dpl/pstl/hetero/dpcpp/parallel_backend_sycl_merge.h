...
struct __parallel_merge_submitter<_OutSizeLimit, _IdType, __internal::__optional_kernel_name<_Name...>>
{
    ...
    auto //__future or event_with_keepalive
    operator()(sycl::queue& __q, _Range1&& __rng1, _Range2&& __rng2, _Range3&& __rng3, _Compare __comp) const
    {
        ...
        // Save the raw pointer into a shared_ptr to return it in __future or __event_with_keepalive and extend the lifetime of the storage.
        ...
        if constexpr (_OutSizeLimit{})
            ...
            return __event_with_keepalive{std::move(__event), std::move(__p_result_and_scratch_storage_base)};
    }

...
using __vec_load_t = oneapi::dpl::__par_backend_hetero::__vector_load<__vec_size>;
template <std::uint8_t __vec_size>
using __vec_store_t = oneapi::dpl::__par_backend_hetero::__vector_store<__vec_size>;
template <std::uint8_t __vec_size>
using __vec_reverse_t = oneapi::dpl::__par_backend_hetero::__vector_reverse<__vec_size>;
template <std::uint8_t __vec_size>
using __vec_walk_t = oneapi::dpl::__par_backend_hetero::__vector_walk<__vec_size>;

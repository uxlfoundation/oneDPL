  ...
  public:
    ...
    __get_value() const
    {
        ...
        else if (__supports_USM_device)
        {
            ...
            __q.memcpy(&__storage.__v, __scratch_buf.get() + __scratch_n + _Idx, 1 * sizeof(_T)).wait();

            oneapi::dpl::__internal::__call_destroy_in_lazy_ctor_storage<_T> __call_destroy{__storage};

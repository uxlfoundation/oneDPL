                      ...
                      _Proj __proj)
{
    ...
    else
    {
        ...
        oneapi::dpl::__par_backend_hetero::__buffer<_ValueT> __out_buffer_holder{__exec.queue(), __n};
            ...
            if (__radix_iter % 2 == 0)
                __event =
                    __parallel_radix_sort_iteration<_RadixSortKernel, __radix_bits, __is_ascending, /*even=*/true>::submit(
                        __exec.queue(), __segments, __radix_iter, __in_rng, __out_rng, __tmp_buf, __event, __proj);
                ...
                __event =
                    __parallel_radix_sort_iteration<_RadixSortKernel, __radix_bits, __is_ascending, /*even=*/false>::submit(
                        __exec.queue(), __segments, __radix_iter, __out_rng, __in_rng, __tmp_buf, __event, __proj);
        }
    }

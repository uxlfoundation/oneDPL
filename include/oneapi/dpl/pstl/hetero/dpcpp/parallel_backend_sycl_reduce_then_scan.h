                                      ...
                                      _Inclusive, _IsUniquePattern)
{
    ...
    using __result_and_scratch_storage_t = __result_and_scratch_storage<_ExecutionPolicy, _ValueType, /* _NResults = */ 1>;
    __result_and_scratch_storage_t __result_and_scratch{__exec, __max_num_sub_groups_global + 2};

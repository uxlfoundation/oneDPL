                                      ...
                                      sycl::event __prior_event = {})
{
    ...
    const std::uint32_t __num_work_groups = oneapi::dpl::__internal::__dpl_bit_ceil(__q.get_device().template get_info<sycl::info::device::max_compute_units>()) / (__q.get_device().is_gpu() ? 4 : 1);

...
using __sub_group_size_t = std::uint8_t;
...
// valid here.
constexpr inline __sub_group_size_t
                          ...
                          __inputs_per_item_t __inputs_per_item, std::uint32_t __inputs_per_work_group)
{
    ...
    if (__inputs_in_group > __inputs_per_work_group - __inputs_per_item)
        return static_cast<__sub_group_count_t>(__ndi.get_sub_group().get_group_linear_range());
    ...
    const __sub_group_count_t __active_work_items =
        oneapi::dpl::__internal::__dpl_ceiling_div(__inputs_in_group, __inputs_per_item);
    const __sub_group_count_t __last_active_sub_group_id = static_cast<__sub_group_count_t>(__dpl_sycl::__group_broadcast(
...
template <typename _ValueType>
_ValueType
__broadcast_sub_group(const sycl::nd_item<1>& __ndi, _ValueType __value, __sub_group_size_t __broadcast_id,
                      __subgroup_only_tag)
{
...
template <bool __init_present, typename _MaskOp, typename _BinaryOp, typename _ValueType, typename _LazyValueType,
          typename _CommTag>
void
__exclusive_sub_group_masked_scan(const sycl::nd_item<1>& __ndi, _MaskOp __mask_fn,
                                  __sub_group_size_t __init_broadcast_id, _ValueType& __value, _BinaryOp __binary_op,
                                  _LazyValueType& __init_and_carry, _CommTag __comm_tag)
{
    __sub_group_size_t __sub_group_local_id = __ndi.get_sub_group().get_local_linear_id();
    const __sub_group_size_t __sub_group_size = __get_reduce_then_scan_actual_sub_group_size(__ndi.get_sub_group());
    for (__sub_group_size_t __shift = 1; __shift < __sub_group_size; __shift <<= 1)
    {
...
template <bool __is_inclusive, bool __init_present, typename _MaskOp, typename _BinaryOp, typename _ValueType,
          typename _LazyValueType, typename _CommTag>
void
__sub_group_masked_scan(const sycl::nd_item<1>& __ndi, _MaskOp __mask_fn, __sub_group_size_t __init_broadcast_id,
                        _ValueType& __value, _BinaryOp __binary_op, _LazyValueType& __init_and_carry,
                        _CommTag __comm_tag)
{
    if constexpr (__is_inclusive)
    {
        __inclusive_sub_group_masked_scan<__init_present>(__ndi, __mask_fn, __init_broadcast_id, __value, __binary_op,
                                                          __init_and_carry, __comm_tag);
    }
    else
    {
        __exclusive_sub_group_masked_scan<__init_present>(__ndi, __mask_fn, __init_broadcast_id, __value, __binary_op,
                                                          __init_and_carry, __comm_tag);
    }
}
                 ...
                 _LazyValueType& __init_and_carry, _ScanOpsTag __comm_tag = {})
{
    ...
    __sub_group_size_t __init_broadcast_id = __get_reduce_then_scan_actual_sub_group_size(__ndi.get_sub_group()) - 1;
    __sub_group_masked_scan<__is_inclusive, __init_present>(__ndi, __mask_fn, __init_broadcast_id, __value, __binary_op,
                                                            __init_and_carry, __comm_tag);
}
                         ...
                         _LazyValueType& __init_and_carry, _SizeType __elements_to_process, _ScanOpsTag __comm_tag = {})
{
    ...
    __sub_group_size_t __init_broadcast_id = __elements_to_process - 1;
    __sub_group_masked_scan<__is_inclusive, __init_present>(__ndi, __mask_fn, __init_broadcast_id, __value, __binary_op,
                                                            __init_and_carry, __comm_tag);
}
...
__scan_through_elements_helper_impl(const sycl::nd_item<1>& __ndi, _GenInput __gen_input,
                                    ...
                                    __sub_group_count_t __sub_group_id, __sub_group_count_t __active_subgroups,
                                    _CommTag __comm_tag)
{
    ...
    if (__is_full_thread)
    {
        ...
        __sub_group_scan<__is_inclusive, __init_present>(__ndi, __scan_input_transform(__v), __binary_op,
    ...
    else
    {
        ...
        if (__sub_group_id < __active_subgroups)
        {
            ...
            if (__iters == 1)
            {
                ...
                __sub_group_scan_partial<__is_inclusive, __init_present>(__ndi, __scan_input_transform(__v),
                                                                         __binary_op, __sub_group_carry,
                                                                         __n - __subgroup_start_id, __comm_tag);
            ...
            else
            {
                ...
                for (__inputs_per_item_t __j = 1; __j < __iters - 1; __j++)
                {
                    ...
                    __sub_group_scan<__is_inclusive, /*__init_present=*/true>(
                        __ndi, __scan_input_transform(__v), __binary_op, __sub_group_carry, __comm_tag);
...
template <bool _Bounded, bool __is_inclusive, bool __init_present, bool __capture_output, bool __is_unique_pattern_v,
          ...
          typename _OnOOBReached = oneapi::dpl::__internal::__no_callback_tag,
        ...
        return __q.submit([&, this](sycl::handler& __cgh) {
            ...
            __cgh.parallel_for<
                _KernelName...>(__nd_range, [=, *this](
                                                ...
                                                __get_reduce_then_scan_req_sg_sz_device())]] {
                const __dpl_sycl::__sub_group __sub_group = __ndi.get_sub_group();
                const __sub_group_size_t __sub_group_size = __get_reduce_then_scan_actual_sub_group_size(__sub_group);
                ...
                __sub_group_count_t __sub_group_id = static_cast<__sub_group_count_t>(__sub_group.get_group_linear_id());
                __sub_group_size_t __sub_group_local_id = __sub_group.get_local_linear_id();
                ...
                __sub_group_count_t __active_subgroups = __count_active_sub_groups(
                ...
                if (__sub_group_id < __active_subgroups)
                {
                    ...
                    __scan_through_elements_helper</*_Bounded*/ false, __is_inclusive, /*__init_present=*/false,
                        ...
                        __in_rng, /*unused*/ __in_rng, __start_id, __start_id_reached, __n, __inputs_per_item,
                ...
                if (__sub_group_id == 0)
                {
                    ...
                    __dispatch_comm_tag(__comm_scan_tag, [&](auto __comm_tag_concrete) {
                        if (__iters == 1)
                        {
                            ...
                            __sub_group_count_t __load_id =
                                std::min(__sub_group_count_t{__sub_group_local_id}, __active_subgroups - 1);
                        ...
                        {
                            std::uint8_t __reduction_scan_id = __sub_group_local_id;
                            ...
                            __sub_group_scan</*__is_inclusive=*/true, /*__init_present=*/false>(
                                __ndi, __v, __reduce_op, __sub_group_carry, __comm_tag_concrete);
                            __temp_ptr[__start_id + __reduction_scan_id] = __v;
                            __reduction_scan_id += __sub_group_size;

                            for (std::uint8_t __i = 1; __i < __iters - 1; __i++)
                            {
        ...
        return __q.submit([&, this](sycl::handler& __cgh) {
            ...
            __cgh.parallel_for<_KernelName...>(__nd_range, [=, *this](sycl::nd_item<1> __ndi)
                ...
                if (__sub_group_id == 0)
                {
                    ...
                    std::uint8_t __load_reduction_id = __sub_group_local_id;
                    std::uint8_t __i = 0;
                    ...
                    if (__group_id > 0)
                    {
                        ...
                        __dispatch_comm_tag(__comm_scan_tag, [&](auto __comm_tag_concrete) {
                            if (__pre_carry_iters == 1)
                            {
                                ...
                                __sub_group_scan_partial</*__is_inclusive=*/true, /*__init_present=*/false>(
                                    __ndi, __value, __reduce_op, __carry_last, __remaining_elements,
                                    __comm_tag_concrete);
                            }
                            else
                            {
                                ...
                                _InitValueType __value = __tmp_ptr[__reduction_id];
                                __sub_group_scan</*__is_inclusive=*/true, /*__init_present=*/false>(
                                    __ndi, __value, __reduce_op, __carry_last, __comm_tag_concrete);
                                           ...
                                           _StopPosInitState __stop_pos_initial_state, sycl::event __prior_event)
{
    ...
    const __sub_group_size_t __min_sub_group_size = *__min_sg_it;
    const __sub_group_size_t __max_sub_group_size = *__max_sg_it;

                                                    ...
                                                    __internal::__optional_kernel_name<_KernelName...>>
{
    ...
    sycl::event
    operator()(oneapi::dpl::__par_backend_hetero::__sycl_queue_ref __q_ref, const sycl::nd_range<1> __nd_range, _InRng&& __in_rng,
               ...
               const std::size_t __block_num) const
    {
        ...
        return __q_ref.queue().submit([&, this](sycl::handler& __cgh) {
    ...
    _ScanInputTransform, _WriteOp, _InitType, __internal::__optional_kernel_name<_KernelName...>>
{
    ...
    sycl::event
    operator()(oneapi::dpl::__par_backend_hetero::__sycl_queue_ref __q_ref, const sycl::nd_range<1> __nd_range, _InRng&& __in_rng, _OutRng&& __out_rng,
               _TmpStorageAcc& __scratch_container, const sycl::event& __prior_event,
               const std::uint32_t __inputs_per_sub_group, const std::uint32_t __inputs_per_item,
               const std::size_t __block_num) const
    {
...
auto
__parallel_transform_reduce_then_scan(oneapi::dpl::__internal::__device_backend_tag, oneapi::dpl::__par_backend_hetero::__sycl_queue_ref __q_ref,
                                      ...
                                      _Inclusive, _IsUniquePattern)
{
    ...
    const std::uint32_t __max_work_group_size = oneapi::dpl::__internal::__max_work_group_size(__q_ref.queue(), 8192);
    ...
    __result_and_scratch_storage<_ValueType> __result_and_scratch{__q_ref.queue(), 1, __num_sub_groups_global + 2};
    ...
    for (std::size_t __b = 0; __b < __num_blocks; ++__b)
    {
        ...
        __event = __reduce_submitter(__q_ref.queue(), __kernel_nd_range, __in_rng, __result_and_scratch, __event,
        ...
        __event = __scan_submitter(__q_ref.queue(), __kernel_nd_range, __in_rng, __out_rng, __result_and_scratch, __event,
                                   __inputs_per_sub_group, __inputs_per_item, __b);

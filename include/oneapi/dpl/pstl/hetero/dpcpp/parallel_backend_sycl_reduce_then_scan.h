                                    ...
                                    _CommTag __comm_tag)
{
    ...
    {
        const std::size_t __iter_local_id = __start_id + __j * __sub_group_size;
        ...
        __sub_group_scan<__is_inclusive>(__ndi, __scan_input_transform(__v), __binary_op, __sub_group_carry,
                                            __comm_tag);
        __write_op(__iter_local_id, __v);
    }
            ...
            __cgh.parallel_for<_KernelName...>(__nd_range, [=, *this](sycl::nd_item<1> __ndi)
                ...
                if (__sub_group_id == 0)
                {
                    ...
                    __dispatch_comm_tag(__comm_scan_tag, [&](auto __comm_tag_concrete) {
                        ...
                        {
                            const std::uint32_t __reduction_scan_id = __sub_group_local_id + __i * __sub_group_size;

                            _InitValueType __v = __v = __sub_group_partials[__reduction_scan_id];
                        ...
                        const std::uint32_t __reduction_scan_id = __sub_group_local_id + (__iters - 1) * __sub_group_size;
            ...
            __cgh.parallel_for<_KernelName...>(__nd_range, [=, *this](sycl::nd_item<1> __ndi)
                ...
                if (__sub_group_id == 0)
                {
                    ...
                    if (__group_id > 0)
                    {
                        ...
                        __dispatch_comm_tag(__comm_scan_tag, [&](auto __comm_tag_concrete) {
                            ...
                            for (std::uint32_t __i = 0; __i + 1 < __pre_carry_iters; __i++)
                            {
                                const std::size_t __reduction_id = __offset + __max_num_sub_groups_local * (__sub_group_local_id + __i * __sub_group_size);
                            ...
                            const std::size_t __reduction_id = __offset + __max_num_sub_groups_local * (__sub_group_local_id + (__pre_carry_iters - 1) * __sub_group_size);
                ...
                if (__sub_group_id < __active_subgroups)
                {
                    __scan_through_elements_helper<_Bounded, __is_inclusive, __is_unique_pattern_v>(
                        ...
                        __in_rng, __out_rng, __start_id, __n, __inputs_per_item, __subgroup_start_id, __comm_scan_tag,

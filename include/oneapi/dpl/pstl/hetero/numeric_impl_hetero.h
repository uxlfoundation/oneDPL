                              ...
                              _BinaryOperation __binary_op, _Inclusive)
{
    ...
    else
    {
        ...
        auto __policy = __par_backend_hetero::make_wrapped_policy<ExecutionPolicyWrapper>(__exec);
        ...
        oneapi::dpl::__internal::__pattern_walk2_brick(
            __tag, __policy, __first_tmp, __last_tmp, __result,
...
_ForwardIterator2
__pattern_adjacent_difference([[maybe_unused]] __hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec,

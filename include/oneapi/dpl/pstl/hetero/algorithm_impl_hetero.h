                ...
                _Function __f)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read_write, _ForwardIterator> __keep;
                ...
                _ForwardIterator1 __last1, _ForwardIterator2 __first2, _Function __f)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__acc_mode1, _ForwardIterator1> __keep1;
    auto __buf1 = __keep1(__first1, __last1);

    oneapi::dpl::__ranges::__get_sycl_range<__acc_mode2, _ForwardIterator2> __keep2;
               ...
               _ForwardIterator1 __last1, _ForwardIterator2 __first2, _Function __f)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read_write, _ForwardIterator1> __keep1;
    auto __buf1 = __keep1(__first1, __last1);

    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read_write, _ForwardIterator2> __keep2;
    auto __buf2 = __keep2(__first2, __first2 + __n);
                ...
                _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator3 __first3, _Function __f)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__acc_mode2, _ForwardIterator2> __keep2;
    auto __buf2 = __keep2(__first2, __first2 + __n);
    oneapi::dpl::__ranges::__get_sycl_range<__acc_mode3, _ForwardIterator3> __keep3;
                      ...
                      _Compare __comp)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _Iterator> __keep;
    auto __buf = __keep(__first, __last);
                        ...
                        _BinaryPredicate __predicate, oneapi::dpl::__internal::__or_semantic)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _Iterator> __keep1;
    auto __buf1 = __keep1(__first, __last - 1);
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _Iterator> __keep2;
                ...
                _Iterator2 __first2, _Iterator2 __last2, _Pred __pred)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _Iterator1> __keep1;
    auto __buf1 = __keep1(__first1, __last1);
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _Iterator2> __keep2;
                  ...
                  _Iterator2 __result_first, _Predicate __pred)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::write, _Iterator2> __keep2;
                         ...
                         _Iterator1 __last, _Iterator2 __result1, _Iterator3 __result2, _UnaryPredicate __pred)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::write, decltype(__zipped_res)> __keep2;
                ...
                _Iterator2 __first2, _Iterator2 __last2, _Iterator3 __d_first, _Compare __comp)
{
    ...
    else
    {
        ...
        oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::write, _Iterator3> __keep3;
                       ...
                       _BidirectionalIterator __last, _ForwardIterator __result)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _BidirectionalIterator> __keep1;
    auto __buf1 = __keep1(__first, __last);
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::write, _ForwardIterator> __keep2;
                        ...
                        _OutputIterator __result, _Compare __comp, _IsOpDifference __is_op_difference)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _ForwardIterator1> __keep1;
    auto __buf1 = __keep1(__first1, __last1);
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _ForwardIterator2> __keep2;
    auto __buf2 = __keep2(__first2, __last2);

    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::write, _OutputIterator> __keep3;
                            ...
                            _Iterator4 __out_values_first, _BinaryPredicate __binary_pred, _BinaryOperator __binary_op)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _Iterator1> __keep_keys;
    auto __keys = __keep_keys(__keys_first, __keys_last);
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _Iterator2> __keep_values;

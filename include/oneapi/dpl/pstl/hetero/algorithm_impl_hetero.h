...
void
__pattern_walk1(__hetero_tag<_BackendTag>, const _ExecutionPolicy& __exec, _ForwardIterator __first,
...
_ForwardIterator2
__pattern_walk2_n(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _ForwardIterator1 __first1,
                  _Size __n, _ForwardIterator2 __first2, _Function __f)
{
...
template <typename _BackendTag, typename _ExecutionPolicy, typename _ForwardIterator, typename _Size,
          typename _Function>
_ForwardIterator
__pattern_walk_brick_n(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _ForwardIterator __first,
...
template <typename _BackendTag, typename _ExecutionPolicy, typename _ForwardIterator1, typename _ForwardIterator2,
          typename _Function>
_ForwardIterator2
__pattern_walk2_transform_if(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec,
...
_ForwardIterator3
__pattern_walk3_transform_if(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec,
                             _ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2,
                             _ForwardIterator3 __first3, _Function __func)
{
    // Require `read_write` access mode for output sequence to force a copy in for host iterators to capture incoming
    // values of the output sequence for elements where the predicate is false. We never actually read from the output
    ...
    return __pattern_walk3<_BackendTag, __par_backend_hetero::access_mode::read,
                           __par_backend_hetero::access_mode::read, __par_backend_hetero::access_mode::read_write>(
        __tag,
        __par_backend_hetero::make_wrapped_policy<__walk3_transform_if_wrapper>(__exec),
...
_ForwardIterator
__pattern_fill_n(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _ForwardIterator __first,
                 _Size __count, const _T& __value)
{
...
template <typename _BackendTag, typename _ExecutionPolicy, typename _Iterator1, typename _Iterator2, typename _Pred>
bool
__pattern_equal(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _Iterator1 __first1,
                _Iterator1 __last1, _Iterator2 __first2, _Pred __pred)
{
...
template <typename _BackendTag, typename _ExecutionPolicy, typename _Iterator1, typename _Iterator2, typename _Pred>
_Iterator1
__pattern_find_end(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _Iterator1 __first,
...
template <typename _BackendTag, typename _ExecutionPolicy, typename _Iterator1, typename _Iterator2, typename _Pred>
_Iterator1
__pattern_find_first_of(__hetero_tag<_BackendTag>, const _ExecutionPolicy& __exec, _Iterator1 __first,
                        _Iterator1 __last, _Iterator2 __s_first, _Iterator2 __s_last, _Pred __pred)
{
...
template <typename _BackendTag, typename _ExecutionPolicy, typename _Iterator, typename _Predicate>
_Iterator
__pattern_remove_if(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _Iterator __first,
...
_Iterator3
__pattern_merge(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _Iterator1 __first1,
                _Iterator1 __last1, _Iterator2 __first2, _Iterator2 __last2, _Iterator3 __d_first, _Compare __comp)
{
    ...
    if (__n1 == 0)
        oneapi::dpl::__internal::__pattern_walk2_brick(
            __tag,
            oneapi::dpl::__par_backend_hetero::make_wrapped_policy<copy_back_wrapper>(__exec),
            __first2, __last2, __d_first,
            oneapi::dpl::__internal::__brick_copy<__hetero_tag<_BackendTag>, _ExecutionPolicy>{});
    else if (__n2 == 0)
        oneapi::dpl::__internal::__pattern_walk2_brick(
            __tag,
            oneapi::dpl::__par_backend_hetero::make_wrapped_policy<copy_back_wrapper2>(__exec),
...
void
__stable_sort_with_projection(__hetero_tag<_BackendTag>, const _ExecutionPolicy& __exec, _Iterator __first,
...
template <typename _BackendTag, typename _ExecutionPolicy, typename _Iterator, typename _UnaryPredicate>
_Iterator
__pattern_partition(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _Iterator __first,
                    _Iterator __last, _UnaryPredicate __pred)
{
...
template <typename _BackendTag, typename _ExecutionPolicy, typename _Iterator, typename _Compare>
void
__pattern_nth_element(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _Iterator __first,
                      _Iterator __nth, _Iterator __last, _Compare __comp)
{
                    ...
                    _OutputIterator __result, _Compare __comp)
{
    ...
    if (__first1 == __last1)
    {
        return oneapi::dpl::__internal::__pattern_walk2_brick(
            __tag,
            oneapi::dpl::__par_backend_hetero::make_wrapped_policy<__set_union_copy_case_1>(__exec),
    ...
    if (__first2 == __last2)
    {
        return oneapi::dpl::__internal::__pattern_walk2_brick(
            __tag,
            oneapi::dpl::__par_backend_hetero::make_wrapped_policy<__set_union_copy_case_2>(__exec),
            __first1, __last1, __result,
            oneapi::dpl::__internal::__brick_copy<__hetero_tag<_BackendTag>, _ExecutionPolicy>{});
    }
                                   ...
                                   _ForwardIterator2 __last2, _OutputIterator __result, _Compare __comp)
{
    ...
    if (__first2 == __last2)
    {
        return oneapi::dpl::__internal::__pattern_walk2_brick(
            __tag,
            oneapi::dpl::__par_backend_hetero::make_wrapped_policy<__set_symmetric_difference_copy_case_2>(__exec),
            __first1, __last1, __result,
            oneapi::dpl::__internal::__brick_copy<__hetero_tag<_BackendTag>, _ExecutionPolicy>{});
    }
                     ...
                     oneapi::dpl::__internal::__difference_t<_Range> __n)
{
    ...
    else //2. n < size/2; 'n' parallel copying
    {
        ...
        oneapi::dpl::__par_backend_hetero::__parallel_for(
            _BackendTag{},
            oneapi::dpl::__par_backend_hetero::make_wrapped_policy<__shift_left_right>(__exec),
            __brick, __n, __rng)
            .__deferrable_wait();
    }
...
template <typename _BackendTag, typename _ExecutionPolicy, typename _Iterator>
_Iterator
__pattern_shift_left(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _Iterator __first,
                     _Iterator __last, typename ::std::iterator_traits<_Iterator>::difference_type __n)
{
    //If (n > 0 && n < m), returns first + (m - n). Otherwise, if n  > 0, returns first. Otherwise, returns last.
    ...
    auto __res = oneapi::dpl::__internal::__pattern_shift_left(__tag, __exec, __buf.all_view(), __n);
    return __first + __res;
}

template <typename _BackendTag, typename _ExecutionPolicy, typename _Iterator>
_Iterator
__pattern_shift_right(__hetero_tag<_BackendTag> __tag, const _ExecutionPolicy& __exec, _Iterator __first,
                      _Iterator __last, typename ::std::iterator_traits<_Iterator>::difference_type __n)
{

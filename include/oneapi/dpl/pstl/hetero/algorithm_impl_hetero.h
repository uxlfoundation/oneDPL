...
__pattern_minmax_element(__hetero_tag<_BackendTag>, _ExecutionPolicy&& __exec, _Iterator __first, _Iterator __last,         // oneapi::dpl::__internal : std::pair<_Iterator, _Iterator>
                         _Compare __comp)
{
    if (__first == __last)

...
struct __pattern_min_element_reduce_fn_fo
{
    ...
    _ReduceValueType operator()(_ReduceValueType __a, _ReduceValueType __b)
    {
        using ::std::get;
                      ...
                      _Compare __comp)
{
    ...
    __pattern_min_element_reduce_fn_fo<_Compare> __reduce_fn{__comp}; // KSATODO moved out
    __pattern_min_element_transform_fn_fo<__transform_fn_fo> __transform_fn; // KSATODO moved out
...
{
    _ReduceValueType operator()(auto __gidx, auto __acc) const
    {
...
struct __pattern_lexicographical_compare_transform_fn
{
    ...
    _ReduceValueType operator()(auto __gidx, auto __acc1, auto __acc2)
    {
                 ...
                 _Iterator __last)
{
    ...
    auto __brick =
        unseq_backend::walk2_vectors_or_scalars<std::decay_t<_ExecutionPolicy>, _Function, decltype(__temp_rng_rw),
                     ...
                     oneapi::dpl::__internal::__difference_t<_Range> __n)
{
    ...
    if (__n >= __mid)
    {
        ...
        auto __brick =
            unseq_backend::walk2_vectors_or_scalars<std::decay_t<_ExecutionPolicy>, _Function, decltype(__src), decltype(__dst)>{

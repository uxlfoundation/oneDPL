...
_OutputIterator
__brick_uninitialized_move(_ForwardIterator __first, _ForwardIterator __last,       // bounds for data1
...
_OutputIterator
__brick_uninitialized_move(_RandomAccessIterator __first, _RandomAccessIterator __last, // bounds for data1
                           _OutputIterator __result1, _OutputIterator __result2,        // bounds for results

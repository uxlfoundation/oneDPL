    ...
    __internal::__except_handler([&]() {
        __par_backend::__parallel_for(__backend_tag{}, ::std::forward<_ExecutionPolicy>(__exec), 0, __n,
            [__f, __rngs...](auto __i, auto __j) {
                auto __last1 = oneapi::dpl::__internal::__get_first_iterator(std::ranges::begin(__rngs)...) + __j;
                oneapi::dpl::__internal::__brick_walk_n(__last1, __f, _IsVector{}, (std::ranges::begin(__rngs) + __i)...);
            });
    });
...
__pattern_walk_n(__serial_tag<_IsVector>, _ExecutionPolicy&& __exec, _Function __f, _Ranges&&... __rngs)
{
    ...
    auto __last1 = oneapi::dpl::__internal::__get_first_iterator(std::ranges::begin(__rngs)...) + __n;
    return oneapi::dpl::__internal::__brick_walk_n(__last1, __f, _IsVector{}, std::ranges::begin(__rngs)...);
}

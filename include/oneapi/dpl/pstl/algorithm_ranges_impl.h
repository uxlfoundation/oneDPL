...
__pattern_find_if(_Tag __tag, _ExecutionPolicy&& __exec, _R&& __r, _Pred __pred, _Proj __proj)
{
    ...
    return oneapi::dpl::__internal::__pattern_find_if(__tag, std::forward<_ExecutionPolicy>(__exec),
                   ...
                   _Proj2 __proj2)
{
    ...
    auto __it = oneapi::dpl::__internal::__pattern_find_end(__tag, std::forward<_ExecutionPolicy>(__exec),
                                                            __first1, __last1,
                                                            __first2, __last2,
                                                            __bin_pred);
...
__pattern_adjacent_find_ranges(_Tag __tag, _ExecutionPolicy&& __exec, _R&& __r, _Pred __pred, _Proj __proj)
{
    ...
    return oneapi::dpl::__internal::__pattern_adjacent_find(
        ...
        std::ranges::begin(__r) + std::ranges::size(__r), __pred_2, oneapi::dpl::__internal::__first_semantic());
}
                 ...
                 _Proj2 __proj2)
{
    ...
    auto __res = oneapi::dpl::__internal::__pattern_search(__tag, std::forward<_ExecutionPolicy>(__exec), __first1,
                                                           __last1, __first2, __last2, __pred_2);
                   ...
                   const _T& __value, _Pred __pred, _Proj __proj)
{
    ...
    oneapi::dpl::__internal::__binary_op<_Pred, _Proj, oneapi::dpl::identity> __pred_2{__pred, __proj,
                                                                                       oneapi::dpl::identity{}};
                      ...
                      _LeafSort __leaf_sort)
{
    ...
    oneapi::dpl::__internal::__pattern_sort(__tag, std::forward<_ExecutionPolicy>(__exec), __first, __last, __comp_2,
                                            __leaf_sort);
                       ...
                       _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    auto [__res1, __res2] = ___merge_path_out_lim(__tag, std::forward<_ExecutionPolicy>(__exec),
                                                  __first1, __n1,
                                                  __first2, __n2,
                                                  __result1, __n_out,
                                                  __comp, __proj1, __proj2);

    return {__res1, __res2, __result1 + __n_out};
}
...
template <typename _Tag, typename _ExecutionPolicy, typename _R1, typename _R2, typename _OutRange, typename _Comp,
          typename _Proj1, typename _Proj2>
__set_union_return_t<_R1, _R2, _OutRange>
__pattern_set_union(_Tag __tag, _ExecutionPolicy&& __exec,
...
template <typename _R1, typename _R2, typename _OutRange, typename _Comp, typename _Proj1, typename _Proj2>
__set_intersection_return_t<_R1, _R2, _OutRange>
__brick_set_intersection(_R1&& __r1, _R2&& __r2, _OutRange&& __out_r,
                         _Comp __comp, _Proj1 __proj1, _Proj2 __proj2,
                         /*__is_vector=*/std::false_type) noexcept
{
...
template <typename _Tag, typename _ExecutionPolicy, typename _R1, typename _R2, typename _OutRange, typename _Comp,
          typename _Proj1, typename _Proj2>
__set_intersection_return_t<_R1, _R2, _OutRange>
__pattern_set_intersection(_Tag __tag, _ExecutionPolicy&& __exec,
                           _R1&& __r1, _R2&& __r2, _OutRange&& __out_r,
                           _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    static_assert(__is_serial_tag_v<_Tag> || __is_parallel_forward_tag_v<_Tag>);
...
template <class _IsVector, typename _ExecutionPolicy, typename _R1, typename _R2, typename _OutRange, typename _Comp,
          typename _Proj1, typename _Proj2>
__set_intersection_return_t<_R1, _R2, _OutRange>
__pattern_set_intersection(__parallel_tag<_IsVector> __tag, _ExecutionPolicy&& __exec,
                           _R1&& __r1, _R2&& __r2, _OutRange&& __out_r,
                           _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    using _RandomAccessIterator1 = std::ranges::iterator_t<_R1>;
...
template <typename _R1, typename _R2, typename _OutRange, typename _Comp, typename _Proj1, typename _Proj2>
__set_difference_return_t<_R1, _OutRange>
__brick_set_difference(_R1&& __r1, _R2&& __r2, _OutRange&& __out_r,
                       _Comp __comp, _Proj1 __proj1, _Proj2 __proj2,
                       /*__is_vector=*/std::false_type) noexcept
{
...
template <typename _Tag, typename _ExecutionPolicy, typename _R1, typename _R2, typename _OutRange, typename _Comp,
          typename _Proj1, typename _Proj2>
__set_difference_return_t<_R1, _OutRange>
__pattern_set_difference(_Tag __tag, _ExecutionPolicy&& __exec,
                         _R1&& __r1, _R2&& __r2, _OutRange&& __out_r,
                         _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    static_assert(__is_serial_tag_v<_Tag> || __is_parallel_forward_tag_v<_Tag>);
                         ...
                         _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    if (__n1 + __n2 > __set_algo_cut_off)
    {
        return __parallel_set_op(
            ...
            __comp, __proj1, __proj2)
            .template positions_reached<__set_difference_return_t<_R1, _OutRange>, /* _R1 */ true, /* _R2 */ false, /* _R3 */ true>();
    }
...
template <typename _R1, typename _R2, typename _OutRange, typename _Comp, typename _Proj1, typename _Proj2>
__set_symmetric_difference_return_t<_R1, _R2, _OutRange>
__brick_set_symmetric_difference(_R1&& __r1, _R2&& __r2, _OutRange&& __out_r,
                                 _Comp __comp, _Proj1 __proj1, _Proj2 __proj2,
                                 /*__is_vector=*/std::false_type) noexcept
{
...
template <typename _Tag, typename _ExecutionPolicy, typename _R1, typename _R2, typename _OutRange, typename _Comp,
          typename _Proj1, typename _Proj2>
__set_symmetric_difference_return_t<_R1, _R2, _OutRange>
__pattern_set_symmetric_difference(_Tag __tag, _ExecutionPolicy&& __exec,
                                   _R1&& __r1, _R2&& __r2, _OutRange&& __out_r,
                                   _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    static_assert(__is_serial_tag_v<_Tag> || __is_parallel_forward_tag_v<_Tag>);

    return __brick_set_symmetric_difference(std::forward<_R1>(__r1), std::forward<_R2>(__r2), std::forward<_OutRange>(__out_r),
                                            __comp, __proj1, __proj2,
                                            typename _Tag::__is_vector{});
}
                                   ...
                                   _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    return oneapi::dpl::__internal::__parallel_set_union_op(
        ...
        __comp, __proj1, __proj2)
        .template positions_reached<__set_symmetric_difference_return_t<_R1, _R2, _OutRange>>();
}
                   ...
                   _Proj2 __proj2)
{
    ...
    const auto& [first, second] = oneapi::dpl::__internal::__pattern_mismatch(
        __tag, std::forward<_ExecutionPolicy>(__exec), __first1, __last1, __first2, __last2, __bin_pred);
...
__pattern_swap_ranges(_Tag __tag, _ExecutionPolicy&& __exec, _R1&& __r1, _R2&& __r2)
{
    ...
    auto [__beg1, __end1] = oneapi::dpl::__ranges::__get_range_bounds(__r1);

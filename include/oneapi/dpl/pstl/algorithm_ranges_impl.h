                   ...
                   _Proj2 __proj2)
{
    ...
    auto __it = oneapi::dpl::__internal::__pattern_find_end(__tag, std::forward<_ExecutionPolicy>(__exec), __first1,
                                                            __last1, __first2, __last2, __bin_pred);
                       ...
                       _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    auto [__first2,  [[maybe_unused]] __last2,      __n2] = oneapi::dpl::__ranges::__get_range_bounds(__r2);
    auto [__result1, [[maybe_unused]] __result2, __n_out] = oneapi::dpl::__ranges::__get_range_bounds(__out_r);
...
{
    auto [__it1,       __end1, __in1_sz] = oneapi::dpl::__ranges::__get_range_bounds(__r1);
    auto [__it2,       __end2, __in2_sz] = oneapi::dpl::__ranges::__get_range_bounds(__r2);
    auto [__out_it, __out_end, __out_sz] = oneapi::dpl::__ranges::__get_range_bounds(__r_out);
                           ...
                           _OutRange&& __out_r, _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    if (__m1 > oneapi::dpl::__internal::__set_algo_cut_off)
    {
        ...
        return __internal::__except_handler([&]() {
            auto [it1, it2, it3] = __internal::__parallel_set_op(
                __tag, std::forward<_ExecutionPolicy>(__exec),
                         ...
                         _OutRange&& __out_r, _Comp __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    {
        auto [it1, it2, it3] = __parallel_set_op(
            __tag, std::forward<_ExecutionPolicy>(__exec),
            __first1, __last1,                              // bounds for data1
            __first2, __last2,                              // bounds for data2
            __result1, __result2,                           // bounds for results

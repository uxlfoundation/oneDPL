...
#if defined(ONEDPL_DISABLE_KT_IN_SORT)
#    undef _ONEDPL_DISABLE_KT_IN_SORT
#    define _ONEDPL_DISABLE_KT_IN_SORT ONEDPL_DISABLE_KT_IN_SORT
#elif !defined(_ONEDPL_DISABLE_KT_IN_SORT)
#    define _ONEDPL_DISABLE_KT_IN_SORT 0
#endif

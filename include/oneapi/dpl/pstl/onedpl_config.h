...
#if defined(ONEDPL_ENABLE_KT_IN_SORT)
#    undef _ONEDPL_ENABLE_KT_IN_SORT
#    define _ONEDPL_ENABLE_KT_IN_SORT ONEDPL_ENABLE_KT_IN_SORT
#elif !defined(_ONEDPL_ENABLE_KT_IN_SORT)
#    define _ONEDPL_ENABLE_KT_IN_SORT 1 //TEMPORARILY SETTING TO 1 FOR TESTING
#endif

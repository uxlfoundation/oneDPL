                                     ...
                                     _Compare __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    // If we have enough space in the output range, use the simpler version of __set_intersection_construct
    // to preserve performance
    if (__n_out >= std::max(__n1, __n2))
        return __set_intersection_construct(__first1, __last1, __first2, __last2, __result1, _copy, _CopyFromFirstSet{},
                                   ...
                                   _Compare __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    // If we have enough space in the output range, use the simpler version of __set_difference_construct
    // to preserve performance
    if (__n_out >= __n1)
        return __set_difference_construct(__first1, __last1, __first2, __last2, __result1, __cc_range, __comp, __proj1, __proj2);
                                             ...
                                             _Compare __comp, _Proj1 __proj1, _Proj2 __proj2)
{
    ...
    // to preserve performance
    if (__n_out >= __n1 + __n2)
        return __set_symmetric_difference_construct(__first1, __last1, __first2, __last2, __result1, __cc_range, __comp, __proj1, __proj2);

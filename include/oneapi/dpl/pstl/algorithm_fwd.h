...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator, class _Function>
void
__pattern_for_each(_Tag, _ExecutionPolicy&&, _ForwardIterator, _ForwardIterator, _Function);
...
template <class _Tag, class _ExecutionPolicy, class _ForwardIterator, class _Size, class _Function>
_ForwardIterator
__pattern_for_each_n(_Tag, _ExecutionPolicy&&, _ForwardIterator, _Size, _Function);
...
__brick_compute_mask(_RandomAccessIterator, _DifferenceType, _IndexPredicate, bool*,
                     /*vector=*/std::false_type) noexcept;
...
__parallel_selective_copy(__parallel_tag<_IsVector>, _ExecutionPolicy&&, _RandomAccessIterator1, _DifferenceType,
                          _RandomAccessIterator2, _DifferenceType, _IndexPredicate);
...
_RandomAccessIterator2 __brick_rotate_copy(_RandomAccessIterator1, _RandomAccessIterator1, _RandomAccessIterator1,
...
_OutputIterator
__pattern_rotate_copy(_Tag, _ExecutionPolicy&&, _ForwardIterator, _ForwardIterator, _ForwardIterator, _OutputIterator,
                      std::size_t) noexcept;

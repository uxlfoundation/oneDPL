...
//The projection is applied to a non-const lvalue, exactly like 'std::projected_value_t' does it: the standard
//indirect callable concepts require a projection to be invocable with 'iter_value_t<I>&', not with an rvalue.

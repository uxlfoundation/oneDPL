...
{
    using type = std::decay_t<_Iterator>;
};

template <typename _Iterator>
struct __base_iterator<_Iterator, std::void_t<decltype(std::declval<std::decay_t<_Iterator>>().base())>>
{
    using type = decltype(std::declval<std::decay_t<_Iterator>>().base());
};

template <typename _Iterator>
using __base_iterator_t = typename __base_iterator<_Iterator>::type;
...
struct __is_equality_comparable<__base_iterator<_Iterator1>, __base_iterator<_Iterator2>,
                                std::void_t<decltype(std::declval<__base_iterator_t<_Iterator1>>() ==
                                                     std::declval<__base_iterator_t<_Iterator2>>())>> : std::true_type
{
};
...
struct __is_equality_comparable<
    ...
    : __is_equality_comparable<__base_iterator<_Iterator1>, __base_iterator<_Iterator2>>
{
};

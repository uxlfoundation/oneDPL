...
struct __count_fn_pred
{
    ...
    auto
    operator()(auto&& __val) const -> decltype(std::ranges::equal_to{}(std::forward<decltype(__val)>(__val), __value))
    {
...
{
    auto
    operator()(auto&&... __args) const -> decltype(std::ranges::stable_sort(std::forward<decltype(__args)>(__args)...))
    {
...
{
    auto
    operator()(auto&&... __args) const -> decltype(std::ranges::sort(std::forward<decltype(__args)>(__args)...))
    {
        return std::ranges::sort(std::forward<decltype(__args)>(__args)...);
    }
};
...
transform(_ExecutionPolicy&& __exec, _Range1&& __rng, _Range2&& __result, _UnaryOperation __op)
{
    ...
    oneapi::dpl::__internal::__ranges::__pattern_walk_n(
        __dispatch_tag, ::std::forward<_ExecutionPolicy>(__exec), __internal::transform_fn{__op}, // KSATODO moved out
        views::all_read(::std::forward<_Range1>(__rng)), views::all_write(::std::forward<_Range2>(__result)));
}
...
transform(_ExecutionPolicy&& __exec, _Range1&& __rng1, _Range2&& __rng2, _Range3&& __result, _BinaryOperation __op)
{
    ...
    oneapi::dpl::__internal::__ranges::__pattern_walk_n(
        __dispatch_tag, ::std::forward<_ExecutionPolicy>(__exec), __internal::transform_fn2{__op}, // KSATODO moved out

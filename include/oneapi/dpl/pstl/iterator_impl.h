...
struct __tuple_util
{
    ...
    {
        oneapi::dpl::__internal::__get<_Np - 1>(__it) = oneapi::dpl::__internal::__get<_Np - 1>(__it) + __forward;
    ...
    {
        ++oneapi::dpl::__internal::__get<_Np - 1>(__it);
...
struct __make_references
{
    ...
    {
        return _TupleReturnType(*oneapi::dpl::__internal::__get<_Ip>(__t)...);
    }
};
...
class zip_forward_iterator
{
  ...
  public:
    ...
    {
        return oneapi::dpl::__internal::__get<0>(__my_it_) == oneapi::dpl::__internal::__get<0>(__it.__my_it_);
    }
    bool
    operator!=(const zip_forward_iterator& __it) const
    {

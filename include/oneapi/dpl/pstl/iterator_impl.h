...
struct __tuple_util
{
    ...
    {
        __dpl_internal::__get<_Np - 1>(__it) = __dpl_internal::__get<_Np - 1>(__it) + __forward;
    ...
    {
        ++__dpl_internal::__get<_Np - 1>(__it);
...
struct __make_references
{
    ...
    {
        return _TupleReturnType(*__dpl_internal::__get<_Ip>(__t)...);
    }
};
...
class zip_forward_iterator
{
  ...
  public:
    ...
    {
        return __dpl_internal::__get<0>(__my_it_) == __dpl_internal::__get<0>(__it.__my_it_);
    }
    bool
    operator!=(const zip_forward_iterator& __it) const
    {

    ...
    return __internal::__except_handler([&__exec, __n1, __first1, __last1, __first2, __last2, __result, __comp,
        ...
        __par_backend::__parallel_strict_scan(
            ...
            [=](_DifferenceType __i, _DifferenceType __len) {                                  // Reduce
                ...
                if (__b != __first1)
                    __b = __internal::__pstl_upper_bound(__b, _DifferenceType{0}, std::distance(__b, __last1),
                                                         std::invoke(__proj1, *__b), __comp, __proj1);

                //try searching for the first element which not equal to *__e
                if (__e != __last1)
                    __e = __internal::__pstl_upper_bound(__e, _DifferenceType{0}, std::distance(__e, __last1),
                ...
                if (__e - __b < 1)
                {
                    ...
                    if (__b != __last1)
                        __bb = __internal::__pstl_lower_bound(__first2, _DifferenceType2{0}, std::distance(__first2, __last2),
                ...
                if (__e != __last1)
                    __ee = __internal::__pstl_lower_bound(__bb, _DifferenceType2{0}, std::distance(__bb, __last2),
                        ...
                        _Proj2 __proj2 = {})
{
    ...
    _RandomAccessIterator1 __left_bound_seq_1 =
        __internal::__pstl_lower_bound(__first1, _DifferenceType{0}, std::distance(__first1, __last1),
    ...
    _RandomAccessIterator2 __left_bound_seq_2 =
        __internal::__pstl_lower_bound(__first2, _DifferenceType2{0}, std::distance(__first2, __last2),

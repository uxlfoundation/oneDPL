...
{
    oneapi::dpl::__internal::__binary_op<_Comp, _Proj2, _Proj1> __pred_2(__comp, __proj2, __proj1);
            ...
            [=, &__it_res_1, &__it_res_2](_Index3 __i, _Index3 __j) {
                ...
                if (__i > 0)
                {
                    ...
                    auto __res_d = *std::lower_bound(__it_d, __it_d + __d_size, 1, [&](auto __d, auto __val) {
                        ...
                        const auto __res = __pred_2(__it_2[__c], __it_1[__r]) ? 0 : 1;
        ...
        __par_backend::__parallel_invoke(
            ...
            [=, &__exec, &__result] {
                __result = __internal::__parallel_set_op(
                    ...
                    [](_DifferenceType1 __n, _DifferenceType1 __m) { return __n + __m; }, __set_union_op, __comp,
                    __proj1, __proj2);
            });
        return __result;
    }

            ...
            [=, &__it_res_1, &__it_res_2](_Index3 __i, _Index3 __j) {
                ...
                if (__i > 0)
                {
                    ...
                    auto __res_d = *std::lower_bound(__it_d, __it_d + __d_size, 1, [&](auto __d, auto __val) {
                        ...
                        const auto __res =
                            __comp(std::invoke(__proj2, __it_2[__c]), std::invoke(__proj1, __it_1[__r])) ? 0 : 1;
...
template <class _IsVector, class _ExecutionPolicy, class _RandomAccessIterator1, class _RandomAccessIterator2,
          ...
          class _Proj1 = oneapi::dpl::identity, class _Proj2 = oneapi::dpl::identity>
_OutputIterator
                  ...
                  _Proj1 __proj1 = {}, _Proj2 __proj2 = {})
{
    ...
    __projected_deref<_RandomAccessIterator1, _Proj1> __invoke_proj1{__proj1};
    //__projected_deref<_RandomAccessIterator2, _Proj2> __invoke_proj2{__proj2};

    return __internal::__except_handler([&__exec, __n1, __first1, __last1, __first2, __last2, __result, __comp,
                                         __size_func, __set_op, &__buf, __proj1, __proj2, __invoke_proj1]() {
            ...
            [=](_DifferenceType __i, _DifferenceType __len) {                                  // Reduce
                ...
                if (__b != __first1)
                    __b = __internal::__pstl_upper_bound(__internal::_SubscriptAdapter{}, __b, __last1,
                                                         __invoke_proj1(__b), __comp, __proj1);
                ...
                if (__e != __last1)
                    __e = __internal::__pstl_upper_bound(__internal::_SubscriptAdapter{}, __e, __last1,
                                                         __invoke_proj1(__e), __comp, __proj1);
                ...
                if (__e - __b < 1)
                {
                    ...
                    if (__b != __last1)
                        __bb = __internal::__pstl_lower_bound(__internal::_SubscriptAdapter{}, __first2, __last2,
                                                              __invoke_proj1(__b), __comp, __proj2);
                ...
                if (__e != __last1)
                    __ee = __internal::__pstl_lower_bound(__internal::_SubscriptAdapter{}, __bb, __last2,
                                                          __invoke_proj1(__e), __comp, __proj2);
                        ...
                        _Proj2 __proj2 = {})
{
    ...
    _RandomAccessIterator1 __left_bound_seq_1 = __internal::__pstl_lower_bound(
        __internal::_SubscriptAdapter{}, __first1, __last1, __invoke_proj2(__first2), __comp, __proj1);
    ...
    _RandomAccessIterator2 __left_bound_seq_2 = __internal::__pstl_lower_bound(
        __internal::_SubscriptAdapter{}, __first2, __last2, __invoke_proj1(__first1), __comp, __proj2);

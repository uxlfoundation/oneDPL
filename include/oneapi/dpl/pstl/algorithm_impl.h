                ...
                _Function __f)
{
    ...
    __internal::__except_handler([&]() {
        __par_backend::__parallel_for_each(__backend_tag{}, __exec, __first, __last, __func);
    });
}
...
__pattern_walk1_n(__parallel_tag<_IsVector> __tag, const _ExecutionPolicy& __exec, _RandomAccessIterator __first, _Size __n,
                  _Function __f)
{
    oneapi::dpl::__internal::__pattern_walk1(__tag, __exec, __first, __first + __n, __f);
    return __first + __n;
}
                      ...
                      typename ::std::iterator_traits<_BidirectionalIterator>::difference_type __n)
{
    ...
    auto __res = oneapi::dpl::__internal::__pattern_shift_left(__tag, __exec, _ReverseIterator(__last),
                                                               _ReverseIterator(__first), __n);

...
#ifndef _ONEDPL_INTERNAL_OMP_PARALLEL_STABLE_SORT_H
                            ...
                            _LeafSort __leaf_sort)
{
    ...
    if (__should_run_serial(__xs, __xe, __default_chunk_size))
    {
...
#endif // _ONEDPL_INTERNAL_OMP_PARALLEL_STABLE_SORT_H

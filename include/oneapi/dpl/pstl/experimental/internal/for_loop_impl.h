...
class __reduction_pack
{
    ...
    {
        ::std::forward<_Fp>(__f)(__current, ::std::get<_Is>(__objects_).__get_induction_or_reduction_value(__p)...); // KSATODO fix get?
    }
    ...
    __combine_impl(const __reduction_pack& __other, ::std::index_sequence<_Is...>)
    {
        (void)::std::initializer_list<int>{
            0, ((void)::std::get<_Is>(__objects_).__combine(::std::get<_Is>(__other.__objects_)), 0)...}; // KSATODO fix get?
    }
    ...
    {
        (void)::std::initializer_list<int>{0, ((void)::std::get<_Is>(__objects_).__finalize(__n), 0)...}; // KSATODO fix get?
    }
                ...
                ::std::tuple<_Rest...>&& __t, ::std::index_sequence<_Is...>)
{
    oneapi::dpl::__internal::__pattern_for_loop(
        ...
        ::std::get<_Is>(::std::move(__t))...); // KSATODO fix get
}
...
__for_loop_repack(_ExecutionPolicy&& __exec, _Ip __start, _Ip __finish, _Sp __stride, ::std::tuple<_Rest...>&& __t)
{
    ...
    oneapi::dpl::__internal::__for_loop_impl(::std::forward<_ExecutionPolicy>(__exec), __start, __finish,
                                             ::std::get<sizeof...(_Rest) - 1>(__t), __stride, ::std::move(__t), // KSATODO fix get

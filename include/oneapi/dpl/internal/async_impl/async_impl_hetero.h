                      ...
                      _ForwardIterator __last, _Function __f)
{
    ...
    return oneapi::dpl::__par_backend_hetero::__future<decltype(__event)>(std::move(__event));
}
                      ...
                      _ForwardIterator1 __last1, _ForwardIterator2 __first2, _Function __f)
{
    ...
    return oneapi::dpl::__par_backend_hetero::__future<decltype(__event), decltype(__first2 + __n)>(std::move(__event),
                                                                                                    __first2 + __n);
}
                      ...
                      _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator3 __first3, _Function __f)
{
    ...
    return oneapi::dpl::__par_backend_hetero::__future<decltype(__event), decltype(__first3 + __n)>(std::move(__event),
                                                                                                    __first3 + __n);
}
                                 ...
                                 _UnaryOperation __unary_op)
{
    ...
    return oneapi::dpl::__par_backend_hetero::__future<decltype(__event), decltype(__storage)>(__event, std::move(__storage));
}
                                    ...
                                    _InitType __init, _BinaryOperation __binary_op, _Inclusive)
{
    ...
    return oneapi::dpl::__par_backend_hetero::__future<decltype(__event), decltype(__result + __n),
                                                       decltype(__storage)>(__event, __result + __n,
                                                                            std::move(__storage));
}

                      ...
                      _ForwardIterator1 __last1, _ForwardIterator2 __first2, _Function __f)
{
    ...
    auto __return_event = oneapi::dpl::__par_backend_hetero::__parallel_for(
        _BackendTag{}, ::std::forward<_ExecutionPolicy>(__exec),
        unseq_backend::walk_n_vectors_or_scalars<_Function>{__f, static_cast<std::size_t>(__n)}, __n, __buf1.all_view(),
        __buf2.all_view());

    return oneapi::dpl::__par_hetero_backend::__add_future(__return_event, __first2 + __n);
}
                      ...
                      _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator3 __first3, _Function __f)
{
    ...
    return oneapi::dpl::__par_hetero_backend::__add_future(__return_event, __first3 + __n);
}
                                    ...
                                    _InitType __init, _BinaryOperation __binary_op, _Inclusive)
{
    ...
    auto __return_event = oneapi::dpl::__par_backend_hetero::__parallel_transform_scan(
    ...
    return oneapi::dpl::__par_hetero_backend::__add_future(__return_event, __result + __n);
}

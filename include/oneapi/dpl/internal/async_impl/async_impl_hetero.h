                      ...
                      _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator3 __first3, _Function __f)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::write, _ForwardIterator3> __keep3;
                                 ...
                                 _BinaryOperation1 __binary_op1, _BinaryOperation2 __binary_op2)
{
    ...
    auto __n = __last1 - __first1;
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _RandomAccessIterator1> __keep1;
    auto __buf1 = __keep1(__first1, __last1);
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _RandomAccessIterator2> __keep2;
    auto __buf2 = __keep2(__first2, __first2 + __n);
                                 ...
                                 _UnaryOperation __unary_op)
{
    ...
    oneapi::dpl::__ranges::__get_sycl_range<__par_backend_hetero::access_mode::read, _ForwardIterator> __keep;
    auto __buf = __keep(__first, __last);

...
## Proposed steps
- [x] Check the correspondence with the latest proposal and the existing corrections ([P2075R6](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2024/p2075r6.pdf), [issue4134](https://cplusplus.github.io/LWG/issue4134), [issue4153](https://cplusplus.github.io/LWG/issue4153)).
    - [x] Correct the I/O operator.
    - [x] Re-check the oneDPL specification.
- [x] Remove experimental namespace.
- [x] Generate KAT vectors for some `w`, `!=32` and `!=64` using Clang trunk and extend the testing (10000th elements).
  - A bug in the Clang's version was identified, with the patch everything works well.
- [x] Review the existing implementations in GCC and Clang to see the principal differences in the implementation.
- [Optional] Add Philox in the oneDPL examples.
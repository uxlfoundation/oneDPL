...
| ONEDPL_CMAKE_QUIET_CHECKS                | BOOL   | Silence expected compiler/header check failures during CMake configuration. Set to OFF to see verbose output for debugging | ON            |

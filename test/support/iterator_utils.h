...
struct iterator_invoker
{
    ...
    {
        invoke_if<Iterator>()(
            std::distance(inputBegin, inputEnd) <= sizeLimit<decltype(std::distance(inputBegin, inputEnd))>, op, std::forward<Policy>(exec),
               ...
               InputIterator2 inputEnd2, OutputIterator outputBegin, OutputIterator outputEnd, Rest&&... rest)
    {
        invoke_if<InputIterator1>()(
            ...
            std::forward<Policy>(exec), make_iterator<InputIterator1>()(inputBegin1), make_iterator<InputIterator1>()(inputEnd1),
...
struct iterator_invoker<IteratorTag, /* IsReverse = */ ::std::true_type>
{
    ...
    {
        if (std::distance(inputBegin, inputEnd) <= sizeLimit<decltype(std::distance(inputBegin, inputEnd))>)
            op(std::forward<Policy>(exec), make_iterator<InputIterator>()(inputEnd), make_iterator<InputIterator>()(inputBegin),
               ...
               InputIterator2 inputEnd2, OutputIterator outputBegin, OutputIterator outputEnd, Rest&&... rest)
    {
        if (std::distance(inputBegin1, inputEnd1) <= sizeLimit<decltype(std::distance(inputBegin1, inputEnd1))>)
            op(std::forward<Policy>(exec), make_iterator<InputIterator1>()(inputEnd1), make_iterator<InputIterator1>()(inputBegin1),

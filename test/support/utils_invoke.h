...
// Clone policy and pass cloned instance as l-value / r-value
// depends on qualifiers of source policy type.
#    define CREATE_NEW_POLICY(policy_src, idx) CLONE_NEW_POLICY(policy_src)

// Clone policy and pass cloned instance as l-value / r-value
// depends on qualifiers of source policy type.
#    define CREATE_NEW_POLICY_WITH_NAME(policy_src, NewKernelName) CLONE_NEW_POLICY(policy_src)

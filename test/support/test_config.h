...
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_CONTAINS 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_COUNT 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_FILL 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_FIND 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_FIND_LAST 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MIN_MAX_ELEMENT 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_REMOVE 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_REMOVE_IF 1
...
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_UNIQUE 1

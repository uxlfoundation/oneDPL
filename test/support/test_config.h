...
#define _PSTL_TEST_LATEST_INTEL_LLVM_COMPILER 20260200
...
// This mirrors _ONEDPL_SYCL2020_SPAN_BROKEN in the library, but detects AdaptiveCpp via the macros its
// compiler driver predefines, since this header is included before any SYCL header which would provide
// ACPP_VERSION_MAJOR.
...
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_CONTAINS_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_CONTAINS_HETERO 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_COUNT_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_COUNT_HETERO 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_FILL_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_FILL_HETERO 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_FIND_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_FIND_HETERO 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_FIND_LAST_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_FIND_LAST_HETERO 1

#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MIN_HOST 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MIN_HETERO 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MIN_ELEMENT_HOST 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MIN_ELEMENT_HETERO 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MAX_HOST 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MAX_HETERO 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MAX_ELEMENT_HOST 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MAX_ELEMENT_HETERO 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MINMAX_HOST 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MINMAX_HETERO 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MINMAX_ELEMENT_HOST 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_MINMAX_ELEMENT_HETERO 1

#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_REMOVE_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_REMOVE_HETERO 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_REMOVE_IF_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_REMOVE_IF_HETERO 1
...
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_SORT_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_SORT_HETERO 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_STABLE_SORT_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_STABLE_SORT_HETERO 1
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_UNIQUE_HOST 0
#define _TEST_CPP20_RANGES_BROKEN_REQUIRES_UNIQUE_HETERO 1

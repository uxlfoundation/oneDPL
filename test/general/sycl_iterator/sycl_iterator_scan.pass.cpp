...
DEFINE_TEST(test_remove_if)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        auto pos = (last - first) / 2;
        auto res1 = ::std::remove_if(CREATE_NEW_POLICY(exec, 0), first, last, __test_remove_if_fn1<T1, decltype(pos)>{pos});
        wait_and_throw(exec);
...
DEFINE_TEST(test_unique)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        // invoke
        auto result_last = ::std::unique(CREATE_NEW_POLICY(exec, 0), first, last, test_unique_fn1);
        wait_and_throw(exec);
...
DEFINE_TEST(test_partition)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        // invoke partition
        //auto res = ::std::partition(CREATE_NEW_POLICY(exec, 0), first, last, test_partition_fn1);
        wait_and_throw(exec);
        ...
        res = ::std::stable_partition(CREATE_NEW_POLICY(exec, 1), first, last, test_partition_fn1);
        wait_and_throw(exec);
...
DEFINE_TEST(test_transform_inclusive_scan)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 last2, Size n)
    {
        ...
        auto res1 = ::std::transform_inclusive_scan(CREATE_NEW_POLICY(exec, 0), first1, last1, first2,
                                                    ::std::plus<T1>(), test_transform_inclusive_scan_fn1, value);
        wait_and_throw(exec);
...
DEFINE_TEST(test_transform_exclusive_scan)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 last2, Size n)
    {
        ...
        auto res1 = ::std::transform_exclusive_scan(CREATE_NEW_POLICY(exec, 2), first1, last1,
...
DEFINE_TEST(test_copy_if)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 last2, Size n)
    {
        ...
        auto res1 = ::std::copy_if(CREATE_NEW_POLICY(exec, 0), first1, last1, first2, test_copy_if_fn1);
        wait_and_throw(exec);
        ...
        auto res2 = ::std::copy_if(CREATE_NEW_POLICY(exec, 1), first1, last1, first2, test_copy_if_fn2);
        wait_and_throw(exec);
...
DEFINE_TEST(test_unique_copy)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 /* last2 */, Size n)
    {
        ...
        auto result_last =
            ::std::unique_copy(CREATE_NEW_POLICY(exec, 0), first1, last1, result_first, test_unique_copy_fn1);
        wait_and_throw(exec);
...
DEFINE_TEST(test_partition_copy)
{
               ...
               Iterator3 /* last3 */, Size n)
    {
        ...
        // invoke
        auto res = ::std::partition_copy(CREATE_NEW_POLICY(exec, 0), first1, last1, first2,

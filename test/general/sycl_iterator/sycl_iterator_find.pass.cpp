...
DEFINE_TEST(test_adjacent_find)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        Iterator result = std::adjacent_find(TestUtils::forward_like<Policy>(policy0), first, last, comp);
        ...
        auto policy1 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        result = std::adjacent_find(TestUtils::forward_like<Policy>(policy1), first, last, comp);
        ...
        auto policy2 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        result = std::adjacent_find(TestUtils::forward_like<Policy>(policy2), first, last, comp);
        ...
        auto policy3 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        result = std::adjacent_find(TestUtils::forward_like<Policy>(policy3), first, last);
        wait_and_throw(exec);
        ...
        auto policy4 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        result = std::adjacent_find(TestUtils::forward_like<Policy>(policy4), first, last, comp);
...
DEFINE_TEST(test_is_sorted_until)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        // check sorted
        auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        Iterator result = std::is_sorted_until(TestUtils::forward_like<Policy>(policy0), first, last, comp);
        Iterator expected = last;
        wait_and_throw(exec);
        ...
        auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
        result = std::is_sorted_until(TestUtils::forward_like<Policy>(policy1), first, last, comp);
        ...
        auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
        result = std::is_sorted_until(TestUtils::forward_like<Policy>(policy2), first, last, comp);
        expected = it;
        wait_and_throw(exec);
        ...
        auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
        result = std::is_sorted_until(TestUtils::forward_like<Policy>(policy3), first, last);
        wait_and_throw(exec);
        ...
        auto policy4 = make_new_policy<new_kernel_name<Policy, 4>>(exec);
        result = std::is_sorted_until(TestUtils::forward_like<Policy>(policy4), first, last, comp);
...
DEFINE_TEST(test_is_sorted)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        // check sorted
        auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        bool result_bool = std::is_sorted(TestUtils::forward_like<Policy>(policy0), first, last, comp);
        ...
        auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
        result_bool = std::is_sorted(TestUtils::forward_like<Policy>(policy1), first, last, comp);
        ...
        auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
        result_bool = std::is_sorted(TestUtils::forward_like<Policy>(policy2), first, last, comp);
        expected_bool = max_dis > 1 ? false : true;
        wait_and_throw(exec);
        ...
        // check unsorted: the middle element (no predicate)
        auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
        result_bool = std::is_sorted(TestUtils::forward_like<Policy>(policy3), first, last);
        wait_and_throw(exec);
        ...
        auto policy4 = make_new_policy<new_kernel_name<Policy, 4>>(exec);
        result_bool = std::is_sorted(TestUtils::forward_like<Policy>(policy4), first, last, comp);
        expected_bool = max_dis > 1 ? false : true;
        wait_and_throw(exec);
...
DEFINE_TEST(test_any_all_none_of)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Size n)
    {
        ...
        {
            auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
            auto res0 = std::any_of(TestUtils::forward_like<Policy>(policy0), first1, first1, IsMinusOneEqTo<T1, Size>{n});
            wait_and_throw(exec);

            EXPECT_TRUE(!res0, "wrong effect from any_of_0");
            auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
            res0 = std::none_of(TestUtils::forward_like<Policy>(policy1), first1, first1, TestUtils::IsEqualTo<T1>{-1});
            wait_and_throw(exec);

            EXPECT_TRUE(res0, "wrong effect from none_of_0");
            auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
            res0 = std::all_of(TestUtils::forward_like<Policy>(policy2), first1, first1, TestUtils::IsEven<T1>{});
            wait_and_throw(exec);
        ...
        // any_of
        auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
        auto res1 = std::any_of(TestUtils::forward_like<Policy>(policy3), first1, last1, IsMinusOneEqTo<T1, Size>{n});
        wait_and_throw(exec);

        EXPECT_TRUE(res1, "wrong effect from any_of_1");
        auto policy4 = make_new_policy<new_kernel_name<Policy, 4>>(exec);
        auto res2 = std::any_of(TestUtils::forward_like<Policy>(policy4), first1, last1, TestUtils::IsEqualTo<T1>{-1});
        wait_and_throw(exec);

        EXPECT_TRUE(!res2, "wrong effect from any_of_2");
        auto policy5 = make_new_policy<new_kernel_name<Policy, 5>>(exec);
        auto res3 = std::any_of(TestUtils::forward_like<Policy>(policy5), first1, last1, TestUtils::IsEven<T1>{});
        wait_and_throw(exec);

        EXPECT_TRUE(res3, "wrong effect from any_of_3");

        //none_of
        auto policy6 = make_new_policy<new_kernel_name<Policy, 6>>(exec);
        auto res4 = std::none_of(TestUtils::forward_like<Policy>(policy6), first1, last1, TestUtils::IsEqualTo<T1>{-1});
        wait_and_throw(exec);

        EXPECT_TRUE(res4, "wrong effect from none_of");

        //all_of
        auto policy7 = make_new_policy<new_kernel_name<Policy, 7>>(exec);
        auto res5 = std::all_of(TestUtils::forward_like<Policy>(policy7), first1, last1, TestUtils::IsEven<T1>{});
        wait_and_throw(exec);
...
DEFINE_TEST(test_find_if)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Size n)
    {
        ...
        {
            auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
            auto res0 = std::find_if(TestUtils::forward_like<Policy>(policy0), first1, first1, IsMinusOneEqTo<T1, Size>{n});
            wait_and_throw(exec);

            EXPECT_TRUE(res0 == first1, "wrong effect from find_if_0");
            auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
            res0 = std::find(TestUtils::forward_like<Policy>(policy1), first1, first1, T1(1));
            wait_and_throw(exec);
        ...
        // find_if
        auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
        auto res1 = std::find_if(TestUtils::forward_like<Policy>(policy2), first1, last1, IsMinusOneEqTo<T1, Size>{n});
        wait_and_throw(exec);

        EXPECT_TRUE((res1 - first1) == n - 1, "wrong effect from find_if_1");

        auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
        auto res2 = std::find_if(TestUtils::forward_like<Policy>(policy3), first1, last1, TestUtils::IsEqualTo<T1>{-1});
        wait_and_throw(exec);

        EXPECT_TRUE(res2 == last1, "wrong effect from find_if_2");

        auto policy4 = make_new_policy<new_kernel_name<Policy, 4>>(exec);
        auto res3 = std::find_if(TestUtils::forward_like<Policy>(policy4), first1, last1, TestUtils::IsEven<T1>{});
        wait_and_throw(exec);
        ...
        //find
        auto policy5 = make_new_policy<new_kernel_name<Policy, 5>>(exec);
        auto res4 = std::find(TestUtils::forward_like<Policy>(policy5), first1, last1, T1(-1));
        wait_and_throw(exec);
...
DEFINE_TEST(test_search_n)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        // Search for sequence at the end
        {
            ...
            auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
            auto res = std::search_n(TestUtils::forward_like<Policy>(policy0), first, last, n - start, T(11));
            wait_and_throw(exec);
        ...
        // Search for sequence in the middle
        {
            ...
            auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
            auto res = std::search_n(TestUtils::forward_like<Policy>(policy1), first, last, end - start, T(22));
            wait_and_throw(exec);
            ...
            auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
            res = std::search_n(TestUtils::forward_like<Policy>(policy2), first, last,
        ...
        // Search for sequence at the beginning
        {
            ...
            auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
            auto res = std::search_n(TestUtils::forward_like<Policy>(policy3), first, last, end, T(33));
            wait_and_throw(exec);
        ...
        // Search for sequence that covers the whole range
        {
            ...
            auto policy4 = make_new_policy<new_kernel_name<Policy, 4>>(exec);
            auto res = std::search_n(TestUtils::forward_like<Policy>(policy4), first, last, n, T(44));
            wait_and_throw(exec);
        ...
        {
            auto policy5 = make_new_policy<new_kernel_name<Policy, 5>>(exec);
            auto res = std::search_n(TestUtils::forward_like<Policy>(policy5), first, last, 2, T(55));
            wait_and_throw(exec);
            ...
            auto policy6 = make_new_policy<new_kernel_name<Policy, 6>>(exec);
            res = std::search_n(TestUtils::forward_like<Policy>(policy6), first, last, (n / 3 + 1), T(33));
            wait_and_throw(exec);
        ...
        {
            auto policy7 = make_new_policy<new_kernel_name<Policy, 7>>(exec);
            auto res = std::search_n(TestUtils::forward_like<Policy>(policy7), first, first, 1, T(5 + n - 1));
            wait_and_throw(exec);
        ...
        if (n > 10)
        {
            ...
            auto policy8 = make_new_policy<new_kernel_name<Policy, 8>>(exec);
            auto res = std::search_n(TestUtils::forward_like<Policy>(policy8), first, last,
        ...
        if (n == 10)
        {
            ...
            auto policy9 = make_new_policy<new_kernel_name<Policy, 9>>(exec);
            auto res = std::search_n(TestUtils::forward_like<Policy>(policy9), first + 1, last, seq_len, T(77));
            wait_and_throw(exec);
...
DEFINE_TEST(test_is_heap)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        auto actual = std::is_heap(TestUtils::forward_like<Policy>(policy0), first, last);
        // True only when n == 1
        wait_and_throw(exec);
        ...
        auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
        actual = std::is_heap(TestUtils::forward_like<Policy>(policy1), first, first);
        wait_and_throw(exec);
        ...
        auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        actual = std::is_heap(TestUtils::forward_like<Policy>(policy0), first, last);
        wait_and_throw(exec);
        ...
        auto end = first + n / 2;
        auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
        actual = std::is_heap(TestUtils::forward_like<Policy>(policy1), first, end);
        wait_and_throw(exec);
        ...
        auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
        actual = std::is_heap(TestUtils::forward_like<Policy>(policy2), first, last);
        wait_and_throw(exec);
...
DEFINE_TEST(test_is_heap_until)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        auto actual = std::is_heap_until(TestUtils::forward_like<Policy>(policy0), first, last);
        wait_and_throw(exec);
        ...
        auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
        actual = std::is_heap_until(TestUtils::forward_like<Policy>(policy2), first, last);
        wait_and_throw(exec);
        ...
        auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
        actual = std::is_heap_until(TestUtils::forward_like<Policy>(policy3), first, last);
        wait_and_throw(exec);
...
DEFINE_TEST(test_equal)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 /* last1 */, Iterator2 first2, Iterator2 /* last2 */, Size n)
    {
        ...
        auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
        auto result = std::equal(TestUtils::forward_like<Policy>(policy0), first1 + new_start,
                                   first1 + new_end, first2 + new_start);
        wait_and_throw(exec);

        EXPECT_TRUE(expected == result, "wrong effect from equal with 3 iterators");
        auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
        result = std::equal(TestUtils::forward_like<Policy>(policy1), first1 + new_start, first1 + new_end,
...
DEFINE_TEST(test_find_first_of)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 last2, Size n)
    {
        ...
        if (n < 2)
        {
            ...
            auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
            auto res =
                std::find_first_of(TestUtils::forward_like<Policy>(policy0), first1, first1, first2, last2);
            wait_and_throw(exec);
        ...
        {
            auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
            auto res = std::find_first_of(TestUtils::forward_like<Policy>(policy1), first1, last1,
                                            first2, first2);
            wait_and_throw(exec);
            ...
            auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
            res = std::find_first_of(TestUtils::forward_like<Policy>(policy2), first1, last1, first2, last2);
            wait_and_throw(exec);
        ...
        else if (n >= 10)
        {
            ...
            auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
            auto res = std::find_first_of(TestUtils::forward_like<Policy>(policy3), first1, last1, first2, last2);
            wait_and_throw(exec);
            ...
            auto policy4 = make_new_policy<new_kernel_name<Policy, 4>>(exec);
            res = std::find_first_of(TestUtils::forward_like<Policy>(policy4), first1, last1, first2, last2);
            wait_and_throw(exec);
...
DEFINE_TEST(test_search)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 last2, Size n)
    {
        ...
        {
            auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
            auto res0 = std::search(TestUtils::forward_like<Policy>(policy0), first1, first1, first2, last2);
            wait_and_throw(exec);

            EXPECT_TRUE(res0 == first1, "wrong effect from search_00");
            auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
            res0 = std::search(TestUtils::forward_like<Policy>(policy1), first1, last1, first2, first2);
            wait_and_throw(exec);

            EXPECT_TRUE(res0 == first1, "wrong effect from search_01");
        }
        auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
        auto res1 = std::search(TestUtils::forward_like<Policy>(policy1), first1, last1, first2, last2);
        ...
        if (n > 10)
        {
            ...
            auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
            auto res2 = std::search(TestUtils::forward_like<Policy>(policy3), first1, last1, first2 + 10, last2);
            wait_and_throw(exec);
        ...
        auto policy4 = make_new_policy<new_kernel_name<Policy, 4>>(exec);
        auto res3 = std::search(TestUtils::forward_like<Policy>(policy4), first1, last1, last1 - 1, last1);
        wait_and_throw(exec);
        ...
        if (n > 5)
        {
            ...
            auto policy5 = make_new_policy<new_kernel_name<Policy, 5>>(exec);
            auto res4 = std::search(TestUtils::forward_like<Policy>(policy5), first1, last1, first2 + 5, first2 + 6);
            wait_and_throw(exec);
...
DEFINE_TEST(test_mismatch)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 last2, Size n)
    {
        ...
        {
            auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
            auto res0 = std::mismatch(TestUtils::forward_like<Policy>(policy0), first1, first1, first2, last2);
            wait_and_throw(exec);

            EXPECT_TRUE(res0.first == first1 && res0.second == first2, "wrong effect from mismatch_00");
            auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
            res0 = std::mismatch(TestUtils::forward_like<Policy>(policy1), first1, last1, first2, first2);
            wait_and_throw(exec);

            EXPECT_TRUE(res0.first == first1 && res0.second == first2, "wrong effect from mismatch_01");
        }
        auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
        auto res1 = std::mismatch(TestUtils::forward_like<Policy>(policy2), first1, last1, first2, last2);
        EXPECT_TRUE(res1.first == first1 && res1.second == first2, "wrong effect from mismatch_1");
        if (n > 5)
        {
            // first n-10 elements of the subsequence are at the beginning of first sequence
            auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
            auto res2 = std::mismatch(TestUtils::forward_like<Policy>(policy3), first1, last1, first2 + 5, last2);
            wait_and_throw(exec);
...
DEFINE_TEST(test_find_end)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 last2, Size n)
    {
        ...
        if (n <= 2)
        {
            ...
            // Empty subsequence
            auto policy0 = make_new_policy<new_kernel_name<Policy, 0>>(exec);
            auto res = std::find_end(TestUtils::forward_like<Policy>(policy0), first1, last1, first2, first2);
            wait_and_throw(exec);
        ...
        if (n > 2 && n < 10)
        {
            ...
            // No subsequence
            auto policy1 = make_new_policy<new_kernel_name<Policy, 1>>(exec);
            auto res = std::find_end(TestUtils::forward_like<Policy>(policy1), first1, last1, first2, first2 + n / 2);
            wait_and_throw(exec);
            ...
            auto policy2 = make_new_policy<new_kernel_name<Policy, 2>>(exec);
            res = std::find_end(TestUtils::forward_like<Policy>(policy2), first1, last1, first2, last2);
            wait_and_throw(exec);
        ...
        if (n >= 10)
        {
            ...
            // Match at the beginning
            {
                ...
                auto policy3 = make_new_policy<new_kernel_name<Policy, 3>>(exec);
                auto res = std::find_end(TestUtils::forward_like<Policy>(policy3), first1, last1, first2,
                                           first2 + n / 5);
                wait_and_throw(exec);
            ...
            // 2 matches: at the beginning and in the middle, should return the latter
            {
                ...
                auto policy4 = make_new_policy<new_kernel_name<Policy, 4>>(exec);
                auto res = std::find_end(TestUtils::forward_like<Policy>(policy4), first1, last1, first2,
                                           first2 + n / 5);
                wait_and_throw(exec);
            ...
            // 3 matches: at the beginning, in the middle and at the end, should return the latter
            {
                ...
                auto policy5 = make_new_policy<new_kernel_name<Policy, 5>>(exec);
                auto res = std::find_end(TestUtils::forward_like<Policy>(policy5), first1, last1, first2,
                                           first2 + n / 5);
                wait_and_throw(exec);

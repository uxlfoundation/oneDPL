...
DEFINE_TEST(test_count_if)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        // check when arbitrary should be counted
        ReturnType expected = (n - 1) / 10 + 1;
        ReturnType result = ::std::count_if(CREATE_NEW_POLICY(exec, 0), first, last, test_count_if_fn1);
        wait_and_throw(exec);
        ...
        // check when none should be counted
        expected = 0;
        result = ::std::count_if(CREATE_NEW_POLICY(exec, 1), first, last, test_count_if_fn2);
        wait_and_throw(exec);
        ...
        // check when all should be counted
        expected = n;
        result = ::std::count_if(CREATE_NEW_POLICY(exec, 2), first, last, test_count_if_fn3);
        wait_and_throw(exec);
...
DEFINE_TEST(test_is_partitioned)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        // check sorted
        bool result_bool = ::std::is_partitioned(CREATE_NEW_POLICY(exec, 0), first, last, __test_is_partitioned_less_than);
        wait_and_throw(exec);

        EXPECT_TRUE(result_bool == expected_bool_less_then, "wrong effect from is_partitioned (Test #1 less than)");

        result_bool = ::std::is_partitioned(CREATE_NEW_POLICY(exec, 1), first, last, __test_is_partitioned_is_odd);
        wait_and_throw(exec);
        ...
        result_bool = ::std::is_partitioned(CREATE_NEW_POLICY(exec, 2), first, last, __test_is_partitioned_is_odd);
        wait_and_throw(exec);
...
DEFINE_TEST(test_lexicographical_compare)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 last2, Size n)
    {
        ...
        is_less_res = ::std::lexicographical_compare(CREATE_NEW_POLICY(exec, 1), first1,
        ...
        is_less_res = ::std::lexicographical_compare(CREATE_NEW_POLICY(exec, 2), first1, last1,
        ...
        is_less_res = ::std::lexicographical_compare(CREATE_NEW_POLICY(exec, 3), first1, last1,
        ...
        is_less_res = ::std::lexicographical_compare(CREATE_NEW_POLICY(exec, 4), first1, last1,
                                                     first2, last2 - 1, test_lexicographical_compare_comp);
        wait_and_throw(exec);
        ...
        is_less_res = ::std::lexicographical_compare(CREATE_NEW_POLICY(exec, 5), first1, last1,
                                                     first2, last2, test_lexicographical_compare_comp);
        wait_and_throw(exec);
        ...
        is_less_res = ::std::lexicographical_compare(CREATE_NEW_POLICY(exec, 6), first1,
                                                     last1 - 1, first2, last2, test_lexicographical_compare_comp);
        wait_and_throw(exec);

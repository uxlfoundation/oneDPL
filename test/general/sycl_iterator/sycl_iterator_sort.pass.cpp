...
DEFINE_TEST(test_sort)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Size n)
    {
        ...
        ::std::sort(CREATE_NEW_POLICY(exec, 0), first1, last1);
        wait_and_throw(exec);
        ...
        ::std::sort(CREATE_NEW_POLICY(exec, 1), first1, last1, ::std::greater<T1>());
        wait_and_throw(exec);
...
DEFINE_TEST(test_stable_sort)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Size n)
    {
        ...
        ::std::stable_sort(CREATE_NEW_POLICY(exec, 0), first1, last1);
        wait_and_throw(exec);
        ...
        ::std::stable_sort(CREATE_NEW_POLICY(exec, 1), first1, last1, ::std::greater<T1>());
        wait_and_throw(exec);
...
DEFINE_TEST(test_partial_sort)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 /* first1 */, Iterator2 /* last2 */, Size n)
    {
        ...
        // Sort a subrange
        {
            ...
            ::std::partial_sort(CREATE_NEW_POLICY(exec, 0), first1, end1, last1);
            wait_and_throw(exec);
        ...
        {
            ::std::partial_sort(CREATE_NEW_POLICY(exec, 1), first1, last1, last1);
            wait_and_throw(exec);
...
DEFINE_TEST(test_partial_sort_copy)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 last2, Size n)
    {
        ...
        // Sort a subrange
        {
            ...
            auto last_sorted =
                ::std::partial_sort_copy(CREATE_NEW_POLICY(exec, 0), first1, last1, first2, end2);
            wait_and_throw(exec);
        ...
        {
            auto last_sorted =
                ::std::partial_sort_copy(CREATE_NEW_POLICY(exec, 2), first1, last1, first2, last2);
            wait_and_throw(exec);
...
DEFINE_TEST(test_inplace_merge)
{
    ...
    operator()(Policy&& exec, Iterator first, Iterator last, Size n)
    {
        ...
        ::std::inplace_merge(CREATE_NEW_POLICY(exec, 0), first, first + (middle - host_keys.get()), last);
        wait_and_throw(exec);
...
DEFINE_TEST(test_nth_element)
{
    ...
    operator()(Policy&& exec, Iterator1 first1, Iterator1 last1, Iterator2 first2, Iterator2 /* last2 */, Size n)
    {
        ...
        ::std::nth_element(CREATE_NEW_POLICY(exec, 0), first1, middle1, last1, comp);
        wait_and_throw(exec);
...
DEFINE_TEST(test_merge)
{
               ...
               Iterator3 /* last3 */, Size n)
    {
        ...
        auto res1 = ::std::merge(CREATE_NEW_POLICY(exec, 0), first1, last1, first2, first2 + x, first3);

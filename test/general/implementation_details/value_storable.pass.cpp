...
// Compile-time checks for oneapi::dpl::__unseq_backend::__is_indirectly_storable_v, the condition that selects
// the vector code path of min_element and minmax_element.
...
//----------------------------------------------------------------------------//
// __is_indirectly_storable_v
//----------------------------------------------------------------------------//

// Accepted value types.
static_assert(dpl_unseq::__is_indirectly_storable_v<int*>);
static_assert(dpl_unseq::__is_indirectly_storable_v<const int*>);
static_assert(dpl_unseq::__is_indirectly_storable_v<std::vector<int>::iterator>);
static_assert(dpl_unseq::__is_indirectly_storable_v<std::vector<int>::const_iterator>);
static_assert(dpl_unseq::__is_indirectly_storable_v<TestUtils::OnlyLessCompare*>);
static_assert(dpl_unseq::__is_indirectly_storable_v<TestUtils::ExplicitDefaultCtorCompare*>);
static_assert(dpl_unseq::__is_indirectly_storable_v<TestUtils::AggregateOfExplicitDefaultCtorCompare*>);
...
static_assert(dpl_unseq::__is_indirectly_storable_v<TestUtils::NoDefaultCtorWrapper<int>*>);
static_assert(!std::is_default_constructible_v<TestUtils::BraceInitOnlyCompare>);
static_assert(dpl_unseq::__is_indirectly_storable_v<TestUtils::BraceInitOnlyCompare*>);
...
static_assert(dpl_unseq::__is_indirectly_storable_v<TestUtils::CopyOnlyNoMoveCompare*>);
static_assert(dpl_unseq::__is_indirectly_storable_v<TestUtils::VoidAssignCompare*>);
static_assert(dpl_unseq::__is_indirectly_storable_v<const TestUtils::ConstCopyOnlyCompare*>);
// A proxy reference is accepted as long as the value type can be copy-initialized from it.
static_assert(dpl_unseq::__is_indirectly_storable_v<std::vector<bool>::iterator>);
static_assert(dpl_unseq::__is_indirectly_storable_v<FakeIterator<int, int>>);
static_assert(dpl_unseq::__is_indirectly_storable_v<FakeIterator<std::pair<int, int>, std::pair<int&, int&>>>);
// Narrowing is accepted: the bricks copy-initialize the value, they do not list-initialize it.
static_assert(dpl_unseq::__is_indirectly_storable_v<NarrowingIterator>);

// Rejected because of the value type: copy assignment, copy construction.
static_assert(!dpl_unseq::__is_indirectly_storable_v<TestUtils::NoCopyAssignCompare*>);
static_assert(!dpl_unseq::__is_indirectly_storable_v<TestUtils::MoveOnlyCompare*>);
...
static_assert(!dpl_unseq::__is_indirectly_storable_v<TestUtils::ExplicitCopyCtorCompare*>);
static_assert(std::is_copy_constructible_v<TestUtils::ConstCopyOnlyCompare>);
static_assert(!dpl_unseq::__is_indirectly_storable_v<TestUtils::ConstCopyOnlyCompare*>);
static_assert(!dpl_unseq::__is_indirectly_storable_v<FakeIterator<int, OpaqueRef>>);
...
static_assert(!dpl_unseq::__is_indirectly_storable_v<
...
static_assert(!dpl_unseq::__is_indirectly_storable_v<std::back_insert_iterator<std::vector<int>>>);

...
test_device_copyable()
{
    ...
    static_assert(
        sycl::is_device_copyable_v<
            oneapi::dpl::__par_backend_hetero::__early_exit_find_or<noop_device_copyable, /*__elems_per_iter=*/1>>,
        "__early_exit_find_or is not device copyable with device copyable types");
    static_assert(
        sycl::is_device_copyable_v<
            oneapi::dpl::__par_backend_hetero::__early_exit_find_or<noop_device_copyable, /*__elems_per_iter=*/4>>,
        "__early_exit_find_or is not device copyable with device copyable types");
...
test_non_device_copyable()
{
    ...
    static_assert(
        !sycl::is_device_copyable_v<
            oneapi::dpl::__par_backend_hetero::__early_exit_find_or<noop_non_device_copyable, /*__elems_per_iter=*/1>>,
        "__early_exit_find_or is device copyable with non device copyable types");
    static_assert(
        !sycl::is_device_copyable_v<
            oneapi::dpl::__par_backend_hetero::__early_exit_find_or<noop_non_device_copyable, /*__elems_per_iter=*/4>>,
        "__early_exit_find_or is device copyable with non device copyable types");

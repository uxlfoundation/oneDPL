...
test_device_copyable()
{
    ...
    static_assert(
        sycl::is_device_copyable_v<
            oneapi::dpl::__par_backend_hetero::__gen_red_by_seg_reduce_input<binary_op_device_copyable, std::uint64_t>>,
        "__gen_red_by_seg_reduce_input is not device copyable with device copyable types");
    ...
    static_assert(
        sycl::is_device_copyable_v<
            oneapi::dpl::__par_backend_hetero::__gen_red_by_seg_scan_input<binary_op_device_copyable, std::uint64_t>>,
        "__gen_red_by_seg_scan_input is not device copyable with device copyable types");

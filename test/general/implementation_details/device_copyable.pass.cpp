...
test_device_copyable()
{
    ...
    //walk_n
    static_assert(sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::walk_n<noop_device_copyable>>,
                  "walk_n is not device copyable with device copyable types");
    //walk1_vector_or_scalar
    static_assert(sycl::is_device_copyable_v<
                      oneapi::dpl::unseq_backend::walk1_vector_or_scalar<noop_device_copyable, range_device_copyable>>,
    ...
    static_assert(sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::walk2_vectors_or_scalars<
                      noop_device_copyable, range_device_copyable, range_device_copyable>>,
    ...
    static_assert(sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::walk3_vectors_or_scalars<
                      noop_device_copyable, range_device_copyable, range_device_copyable, range_device_copyable>>,
    ...
    static_assert(sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::transform_reduce<
                      noop_device_copyable, noop_device_copyable, int_device_copyable, std::true_type, 4>>,
                  "transform_reduce is not device copyable with device copyable types");
    //reduce_over_group
    static_assert(sycl::is_device_copyable_v<
                      oneapi::dpl::unseq_backend::reduce_over_group<noop_device_copyable, int_device_copyable>>,
                  "reduce_over_group is not device copyable with device copyable types");
    //single_match_pred_by_idx
    static_assert(
        sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::single_match_pred_by_idx<noop_device_copyable>>,
        "single_match_pred_by_idx is not device copyable with device copyable types");
    //single_match_pred
    static_assert(sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::single_match_pred<noop_device_copyable>>,
                  "single_match_pred is not device copyable with device copyable types");
    //multiple_match_pred
    static_assert(sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::multiple_match_pred<noop_device_copyable>>,
    ...
    //first_match_pred
    static_assert(sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::first_match_pred<noop_device_copyable>>,
    ...
    static_assert(
        sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::__scan<
            std::true_type, noop_device_copyable, noop_device_copyable, noop_device_copyable, noop_device_copyable,
    ...
    // __brick_set_op
    static_assert(
        sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::__brick_set_op<noop_device_copyable, int_device_copyable,
                                                                              int_device_copyable, std::true_type>>,
    ...
    static_assert(
        sycl::is_device_copyable_v<oneapi::dpl::__par_backend_hetero::__early_exit_find_or<noop_device_copyable>>,
    ...
    //__brick_fill
    static_assert(
        sycl::is_device_copyable_v<oneapi::dpl::__internal::__brick_fill<hetero_device_tag, int_device_copyable>>,
        "__brick_fill is not device copyable with device copyable types");
    //__brick_fill_n
    static_assert(
        sycl::is_device_copyable_v<oneapi::dpl::__internal::__brick_fill_n<hetero_device_tag, int_device_copyable>>,
...
test_non_device_copyable()
{
    ...
    static_assert(
        !sycl::is_device_copyable_v<
            oneapi::dpl::unseq_backend::walk1_vector_or_scalar<noop_non_device_copyable, range_non_device_copyable>>,
        "walk1_vector_or_scalar is device copyable with non device copyable types");
    //walk2_vectors_or_scalars
    static_assert(!sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::walk2_vectors_or_scalars<
                      noop_non_device_copyable, range_non_device_copyable, range_non_device_copyable>>,
                  "walk2_vectors_or_scalars is device copyable with non device copyable types");
    //walk3_vectors_or_scalars
    static_assert(
        !sycl::is_device_copyable_v<oneapi::dpl::unseq_backend::walk3_vectors_or_scalars<
            noop_non_device_copyable, range_non_device_copyable, range_non_device_copyable, range_non_device_copyable>>,

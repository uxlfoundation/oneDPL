...
#elif defined(TEST_KT_BACKEND_SYCL)
template <typename KernelParam, typename T, typename V>
bool
can_run_test(sycl::queue q, KernelParam param, std::bool_constant<false>)
{
    return true;
}
...
template <typename KernelParam, typename T, typename V>
bool
can_run_test(sycl::queue q, KernelParam param, std::bool_constant<true>)
{
    return true;
}
#endif

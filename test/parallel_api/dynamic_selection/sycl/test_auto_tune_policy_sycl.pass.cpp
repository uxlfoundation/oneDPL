...
main()
{
    ...
    try
    {
        ...
        if (u1.size() != 0 || u2.size() !=0 )
        {
            ...
            EXPECT_EQ(0, (test_auto_submit_wait_on_event<policy_t, class Kernel3>(u1, 2)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_event<policy_t, class Kernel4>(u1, 3)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_group<policy_t, class Kernel5>(u1, 0)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_group<policy_t, class Kernel6>(u1, 1)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_group<policy_t, class Kernel7>(u1, 2)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_group<policy_t, class Kernel8>(u1, 3)), "");
            EXPECT_EQ(0, (test_auto_submit_and_wait<policy_t, class Kernel9>(u1, 0)), "");
            EXPECT_EQ(0, (test_auto_submit_and_wait<policy_t, class Kernel10>(u1, 1)), "");
            EXPECT_EQ(0, (test_auto_submit_and_wait<policy_t, class Kernel11>(u1, 2)), "");
            EXPECT_EQ(0, (test_auto_submit_and_wait<policy_t, class Kernel12>(u1, 3)), "");
            // Use event profiling
            EXPECT_EQ(0, (test_auto_submit_wait_on_event<policy_t, class Kernel25>(u2, 0)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_event<policy_t, class Kernel26>(u2, 1)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_event<policy_t, class Kernel27>(u2, 2)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_event<policy_t, class Kernel28>(u2, 3)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_group<policy_t, class Kernel29>(u2, 0)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_group<policy_t, class Kernel30>(u2, 1)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_group<policy_t, class Kernel31>(u2, 2)), "");
            EXPECT_EQ(0, (test_auto_submit_wait_on_group<policy_t, class Kernel32>(u2, 3)), "");
            EXPECT_EQ(0, (test_auto_submit_and_wait<policy_t, class Kernel33>(u2, 0)), "");
            EXPECT_EQ(0, (test_auto_submit_and_wait<policy_t, class Kernel34>(u2, 1)), "");
            EXPECT_EQ(0, (test_auto_submit_and_wait<policy_t, class Kernel35>(u2, 2)), "");
            EXPECT_EQ(0, (test_auto_submit_and_wait<policy_t, class Kernel36>(u2, 3)), "");

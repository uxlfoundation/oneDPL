...
struct test_one_policy
{
               ...
               Size shift)
    {
        ...
        Iterator actual_return = rotate(CLONE_NEW_POLICY(exec), actual_b, actual_m, actual_e);
        ...
        EXPECT_TRUE(check_move(CLONE_NEW_POLICY(exec), actual_b, actual_e, shift), "wrong move test of rotate");
    }

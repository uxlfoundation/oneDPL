...
// The crashing coordinate with a staging temporary per iteration instead of one per call. Passing here
// both names the mechanism and gives a candidate fix.

#include <cstddef>

#define _ONEDPL_COMPACTION_DIAG_FRESH_BUF 1

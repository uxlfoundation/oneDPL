...
DEFINE_TEST_2(test_exclusive_scan_by_segment, BinaryPredicate, BinaryOperation)
{
               ...
               Iterator3 val_res_first, Iterator3 /*val_res_last*/, Size n)
    {
        ...
        auto res1 = oneapi::dpl::exclusive_scan_by_segment(CLONE_NEW_POLICY(exec), keys_first, keys_last, vals_first, val_res_first);
        ...
        initialize_data(keys_first, vals_first, val_res_first, n);
        auto res2 =
            oneapi::dpl::exclusive_scan_by_segment(CLONE_NEW_POLICY(exec), keys_first, keys_last, vals_first, val_res_first, init);
        ...
        // call algorithm with init and predicate
        initialize_data(keys_first, vals_first, val_res_first, n);
        auto res3 = oneapi::dpl::exclusive_scan_by_segment(CLONE_NEW_POLICY(exec), keys_first, keys_last, vals_first, val_res_first, init,
                                                           BinaryPredicate());
        ...
        // call algorithm with init, predicate, and operator
        initialize_data(keys_first, vals_first, val_res_first, n);
        auto res4 = oneapi::dpl::exclusive_scan_by_segment(CLONE_NEW_POLICY(exec), keys_first, keys_last, vals_first, val_res_first, init,

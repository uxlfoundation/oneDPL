...
DEFINE_TEST_2(test_exclusive_scan_by_segment, BinaryPredicate, BinaryOperation)
{
               ...
               Iterator3 val_res_first, Iterator3 val_res_last, Size n)
    {
        ...
        auto res1 = oneapi::dpl::exclusive_scan_by_segment(CREATE_NEW_POLICY(exec, 0), keys_first, keys_last, vals_first, val_res_first);
        ...
        auto res2 = oneapi::dpl::exclusive_scan_by_segment(CREATE_NEW_POLICY(exec, 1), keys_first, keys_last, vals_first, val_res_first, init);
        exec.queue().wait_and_throw();

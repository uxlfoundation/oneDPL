...
//
//===----------------------------------------------------------------------===//
// Isolation test: Cap work_group_size to 32 (1 subgroup per WG).
// Tests whether stack usage scales with WG size. If this passes,
// the 256-element WG stack frame is too large for /RTC1 on CPU.

#define _ONEDPL_RTS_OVERRIDE_WG_SIZE_CAP 32

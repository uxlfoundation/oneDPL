...
// ---------- kernel names ----------
class ReduceK3dMatSg32;
class ScanK3dMatSg32;
...
struct reduce_submitter_3d
{
               ...
               const std::size_t __inputs_remaining, const std::size_t __block_num) const
    {
        return __q.submit([&, *this](sycl::handler& cgh) {
            ...
            cgh.parallel_for<ReduceK3dMatSg32>(__nd_range, [=, *this](sycl::nd_item<1> ndi) [[sycl::reqd_sub_group_size(32)]] {
...
struct scan_submitter_3d
{
               ...
               const std::size_t __inputs_remaining, const std::size_t __block_num) const
    {
        ...
        return __q.submit([&, *this](sycl::handler& cgh) {
            ...
            cgh.parallel_for<ScanK3dMatSg32>(__nd_range, [=, *this](sycl::nd_item<1> ndi) [[sycl::reqd_sub_group_size(32)]] {
                T* __tmp_acc = _TmpStorageAcc::__get_usm_or_buffer_accessor_ptr(__temp_acc);
...
int run_test() {
    ...
    std::printf("[bridge3d_mat_sg32] Device: %s\n", dev.get_info<sycl::info::device::name>().c_str());
    ...
    std::printf("[bridge3d_mat_sg32] wg_size=%u num_wg=%u ipi=%u blocks=%zu scratch=%u\n",

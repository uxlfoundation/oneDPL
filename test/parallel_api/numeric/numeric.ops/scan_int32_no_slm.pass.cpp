...
//
//===----------------------------------------------------------------------===//
// Isolation test: Force __use_slm_for_comm=false on CPU (use subgroup ops path
// instead of SLM emulation). If this passes, SLM emulation is the culprit.

#define _ONEDPL_RTS_OVERRIDE_USE_SLM false

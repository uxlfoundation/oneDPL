...
test_with_usm(Policy&& policy, BinaryOp binary_op)
{
    ...
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper1(policy.queue(), keys1, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper2(policy.queue(), keys2, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper3(policy.queue(), values1, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper4(policy.queue(), values2, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper5(policy.queue(), output_keys1, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper6(policy.queue(), output_keys2, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper7(policy.queue(), output_values1, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper8(policy.queue(), output_values2, n);
...
test_zip_with_discard(Policy&& policy, BinaryOp binary_op)
{
    ...
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper3(policy.queue(), values1, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper4(policy.queue(), values2, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper5(policy.queue(), output_keys, n);
    TestUtils::usm_data_transfer<alloc_type, int> dt_helper6(policy.queue(), output_values, n);
    auto d_keys1 = dt_helper1.get_data();
    auto d_keys2 = dt_helper2.get_data();
    auto d_values1 = dt_helper3.get_data();
    auto d_values2 = dt_helper4.get_data();
...
{
    test_impl(CLONE_NEW_POLICY(policy), TestUtils::TupleAddFunctor1{});
    test_impl(CLONE_NEW_POLICY(policy), TestUtils::TupleAddFunctor2{});
}

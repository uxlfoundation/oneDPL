...
void test1_with_buffers(Policy&& policy)
{
    ...
    auto res_3 = oneapi::dpl::experimental::transform_async(
        CREATE_NEW_POLICY_WITH_NAME(policy, Transform2),
    ...
    auto alpha = oneapi::dpl::experimental::reduce_async(
        CREATE_NEW_POLICY_WITH_NAME(policy, Reduce1),
    ...
    auto beta = oneapi::dpl::experimental::transform_reduce_async(
        CREATE_NEW_POLICY_WITH_NAME(policy, Reduce2),
    ...
    auto epsilon = oneapi::dpl::experimental::reduce_async(
        CREATE_NEW_POLICY_WITH_NAME(policy, Reduce3),
...
test_with_usm(Policy&& policy)
{
    ...
    using _NewKernelName1 = TestUtils::unique_kernel_name<async1, TestUtils::uniq_kernel_index<alloc_type>()>;
    ...
    using _NewKernelName2 = TestUtils::unique_kernel_name<async2, TestUtils::uniq_kernel_index<alloc_type>()>;
    ...
    using _NewKernelName3 = TestUtils::unique_kernel_name<async3, TestUtils::uniq_kernel_index<alloc_type>()>;

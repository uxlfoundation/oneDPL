...
main()
{
    ...
    test_range_algo<1, int, data_in_in_out>{big_sz}(dpl_ranges::set_symmetric_difference,
                                                    checker,std::ranges::less{}, proj);

    test_range_algo<2, int, data_in_in_out>{}(dpl_ranges::set_symmetric_difference,
                                              checker, std::ranges::less{}, proj, proj);
    test_range_algo<3,  P2, data_in_in_out>{}(dpl_ranges::set_symmetric_difference,
                                              checker, std::ranges::less{}, &P2::x, &P2::x);
    test_range_algo<4,  P2, data_in_in_out>{}(dpl_ranges::set_symmetric_difference,
                                              checker, std::ranges::less{}, &P2::proj, &P2::proj);

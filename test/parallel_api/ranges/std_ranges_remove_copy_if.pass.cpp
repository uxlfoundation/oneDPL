...
main()
{
    ...
    test_range_algo<0, int, data_in_out_lim>{get_scan_big_sz()}(dpl_ranges::remove_copy_if, remove_copy_if_checker, pred);
    ...
    test_range_algo<5, P2, data_in_out_lim, repeating_gen>{}(dpl_ranges::remove_copy_if, remove_copy_if_checker, modulo_3_is_1, &P2::x);
    test_range_algo<6, P2, data_in_out_lim>{}(dpl_ranges::remove_copy_if, remove_copy_if_checker, pred, &P2::proj);
#endif
#endif // _ENABLE_STD_RANGES_TESTING

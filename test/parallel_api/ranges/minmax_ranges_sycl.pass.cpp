...
test_impl(Policy&& exec)
{
    ...
    using namespace oneapi::dpl::experimental::ranges;
    {
        ...
        //min element
        res1 = min_element(CREATE_NEW_POLICY(exec, 0), A);
        res2 = min_element(CREATE_NEW_POLICY(exec, 1), view, std::less<int>());
        res3 = min_element(CREATE_NEW_POLICY(exec, 2), view | views::take(1));

        //max_element
        res4 = max_element(CREATE_NEW_POLICY(exec, 3), A);
        res5 = max_element(CREATE_NEW_POLICY(exec, 4), view, std::less<int>());

        res_minmax1 = minmax_element(CREATE_NEW_POLICY(exec, 5), A);
        res_minmax2 = minmax_element(CREATE_NEW_POLICY(exec, 6), view, std::less<int>());
    }

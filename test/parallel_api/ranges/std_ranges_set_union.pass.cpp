...
main()
{
    ...
    test_range_algo<2, int, data_in_in_out>{}(dpl_ranges::set_union, set_union_checker, std::ranges::greater{}, proj, proj);
    test_range_algo<3, P2, data_in_in_out>{}(dpl_ranges::set_union, set_union_checker, pred, &P2::x, &P2::x);
    test_range_algo<4, P2, data_in_in_out>{}(dpl_ranges::set_union, set_union_checker, pred, &P2::proj, &P2::proj);

...
static_assert(ONEDPL_HAS_RANGE_ALGORITHMS >= 202604L);
...
#if PSTL_USE_DEBUG
inline constexpr int big_size = 200; //(1<<22) + 37; //4M
#else
// The largest specializations of algorithms with device policies handle 16M+ elements.
inline constexpr int big_size = 200; //(1<<24) + 10; //16M
#endif
...
inline constexpr int medium_size = 100; //(1<<17) + 10; //128K

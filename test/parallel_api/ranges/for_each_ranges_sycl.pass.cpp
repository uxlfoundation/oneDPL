...
test_impl(Policy&& exec)
{
...

    {
        ...
        for_each(CLONE_TEST_POLICY_IDX(exec, 0), all_view<int, sycl::access::mode::read_write>(A), lambda1);
        for_each(CLONE_TEST_POLICY_IDX(exec, 1), A, lambda1); //check with passing sycl::buffer directly
    }

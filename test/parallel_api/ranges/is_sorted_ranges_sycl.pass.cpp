...
void test(Policy&& exec)
{
    ...
    using namespace oneapi::dpl::experimental::ranges;
    {
        ...
        res1 = is_sorted(CREATE_NEW_POLICY(exec, 0), all_view(A));
        res2 = is_sorted(CREATE_NEW_POLICY(exec, 1), B);
        res3 = is_sorted(CREATE_NEW_POLICY(exec, 2), A, [](auto a, auto b) { return a > b;});
    }

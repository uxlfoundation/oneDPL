...
main()
{
    ...
    using namespace oneapi::dpl::experimental::ranges;
    {
        ...
        res2 = find_if(make_new_policy<new_kernel_name<Policy, 2>>(exec), view, TestUtils::IsEqualTo<int>{val});
        res2 = find_if(make_new_policy<new_kernel_name<Policy, 3>>(exec), A, TestUtils::IsEqualTo<int>{val});
        res3 = find_if_not(make_new_policy<new_kernel_name<Policy, 4>>(exec), view, TestUtils::IsGreatThen<int>{0});
        res3 = find_if_not(make_new_policy<new_kernel_name<Policy, 5>>(exec), A, TestUtils::IsGreatThen<int>{0});
    }

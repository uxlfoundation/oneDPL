...
test_impl(Policy&& exec)
{
    ...
    using namespace oneapi::dpl::experimental::ranges;
    {
        ...
        res2 = find_if(CREATE_NEW_POLICY(exec, 2), view, IsEqOp<int>{val});
        res2 = find_if(CREATE_NEW_POLICY(exec, 3), A, IsEqOp<int>{val});
        res3 = find_if_not(CREATE_NEW_POLICY(exec, 4), view, IsGreatThanZeroOp());
        res3 = find_if_not(CREATE_NEW_POLICY(exec, 5), A, IsGreatThanZeroOp());
    }

...
test_impl(Policy&& exec)
{
    ...
    auto res1 = unique_copy(CREATE_NEW_POLICY(exec, 0), views::all_read(C), A);
    auto res2 = unique_copy(CREATE_NEW_POLICY(exec, 1), views::all_read(C), views::all_write(B), is_equal);

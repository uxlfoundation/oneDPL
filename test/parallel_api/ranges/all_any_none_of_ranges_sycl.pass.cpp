...
test_impl(Policy&& exec)
{
    ...
    using namespace oneapi::dpl::experimental::ranges;
    {
        ...
        res1 = any_of(CREATE_NEW_POLICY(exec, 0), views::all(A), lambda);
        res2 = all_of(CREATE_NEW_POLICY(exec, 1), B, lambda);
        res3 = none_of(CREATE_NEW_POLICY(exec, 2), B, [](auto i) { return i == -1; });
    }

...
main()
{
    ...
    test_range_algo<1>{}(dpl_ranges::sort, sort_checker, std::ranges::greater{}, proj);

#if TEST_LONG_RUN
    test_range_algo<2>{}(dpl_ranges::sort, sort_checker, std::ranges::less{});

    test_range_algo<3>{}(dpl_ranges::sort, sort_checker, std::ranges::less{}, proj);

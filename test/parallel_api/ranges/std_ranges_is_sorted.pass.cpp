...
main()
{
    ...
    test_range_algo<1>{}(dpl_ranges::is_sorted, is_sorted_checker, std::ranges::greater{}, proj);

#if TEST_LONG_RUN
    test_range_algo<2>{}(dpl_ranges::is_sorted, is_sorted_checker, std::ranges::less{}, proj);
    test_range_algo<3, P2>{}(dpl_ranges::is_sorted, is_sorted_checker, std::ranges::less{}, &P2::x);
    test_range_algo<4, P2>{}(dpl_ranges::is_sorted, is_sorted_checker, std::ranges::less{}, &P2::proj);

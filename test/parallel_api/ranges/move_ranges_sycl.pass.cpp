...
test_impl(Policy&& exec)
{
...

    {
        ...
        move(CLONE_TEST_POLICY_IDX(exec, 0), view, C); //check passing a buffer for writing
        move(CLONE_TEST_POLICY_IDX(exec, 1), C, range_res); //check passing a buffer for reading
    }

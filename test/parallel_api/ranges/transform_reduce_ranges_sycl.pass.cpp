...
void test(Policy&& exec)
{
    ...
    auto res1 = -1, res2 = -1, res3 = -1;
    {
        ...
        res1 = oneapi::dpl::experimental::ranges::transform_reduce(CREATE_NEW_POLICY(exec, 0), A, view, 0);
        res2 = oneapi::dpl::experimental::ranges::transform_reduce(CREATE_NEW_POLICY(exec, 1), view, A, 0, std::plus<int>(), std::multiplies<int>());
        res3 = oneapi::dpl::experimental::ranges::transform_reduce(CREATE_NEW_POLICY(exec, 2), view, 0, std::plus<int>(), lambda1);
    }

...
void test(Policy&& exec)
{
    ...
    using namespace oneapi::dpl::experimental::ranges;
    {
        ...
        stable_sort(CREATE_NEW_POLICY(exec, 0), A); //check passing sycl buffer directly
        stable_sort(CREATE_NEW_POLICY(exec, 1), all_view<int, sycl::access::mode::read_write>(B), std::greater<int>());
    }

...
struct
{
    ...
    void test_self()
    {
        ...
        struct TestCase {
            ...
            std::size_t expected_in_end;
            std::size_t expected_out_end;
        } test_cases[] = {
...
main()
{
    ...
    test_range_algo<1, int, data_in_out>{}(dpl_ranges::unique_copy,  unique_copy_checker, std::ranges::not_equal_to{}, proj);

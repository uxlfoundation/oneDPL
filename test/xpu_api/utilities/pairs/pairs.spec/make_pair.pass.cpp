...
kernel_test()
{
    ...
    deviceQueue.submit([&](sycl::handler& cgh) {
        ...
        cgh.single_task<class KernelPairTest>([=]() {
            ...
            P1 p1 = dpl::make_pair(3, static_cast<short>(4));
            ret_access[0] = (p1.first == 3);
            ret_access[0] &= (p1.second == 4);

            int elem1 = 3;
            typedef dpl::pair<int*, short> P2;
            P2 p2 = dpl::make_pair(&elem1, static_cast<short>(4));
            ret_access[0] &= (*p2.first == 3);
            ret_access[0] &= (p2.second == 4);

            P2 p2_null = dpl::make_pair(nullptr, static_cast<short>(4));

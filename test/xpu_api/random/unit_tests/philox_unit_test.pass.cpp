...
using philox2x64_w15 = oneapi::dpl::philox_engine<std::uint_fast64_t, 15, 2, 10, 0xD2B74407B1CE6E93, 0x9E3779B97F4A7C15>;
using philox2x64_w18 = oneapi::dpl::philox_engine<std::uint_fast64_t, 18, 2, 10, 0xD2B74407B1CE6E93, 0x9E3779B97F4A7C15>;
using philox2x64_w25 = oneapi::dpl::philox_engine<std::uint_fast64_t, 25, 2, 10, 0xD2B74407B1CE6E93, 0x9E3779B97F4A7C15>;
using philox2x64_w49 = oneapi::dpl::philox_engine<std::uint_fast64_t, 49, 2, 10, 0xD2B74407B1CE6E93, 0x9E3779B97F4A7C15>;

// Philox with word_count = 4
using philox4x32_w5 = oneapi::dpl::philox_engine<std::uint_fast32_t, 5, 4, 10, 0xCD9E8D57, 0x9E3779B9, 0xD2511F53, 0xBB67AE85>;
using philox4x32_w15 = oneapi::dpl::philox_engine<std::uint_fast32_t, 15, 4, 10, 0xCD9E8D57, 0x9E3779B9, 0xD2511F53, 0xBB67AE85>;
using philox4x32_w18 = oneapi::dpl::philox_engine<std::uint_fast32_t, 18, 4, 10, 0xCD9E8D57, 0x9E3779B9, 0xD2511F53, 0xBB67AE85>;
using philox4x32_w30 = oneapi::dpl::philox_engine<std::uint_fast32_t, 30, 4, 10, 0xCD9E8D57, 0x9E3779B9, 0xD2511F53, 0xBB67AE85>;
using philox4x64_w5 =
    oneapi::dpl::philox_engine<std::uint_fast64_t, 5, 4, 10, 0xCA5A826395121157, 0x9E3779B97F4A7C15,
                                             0xD2E7470EE14C6C93, 0xBB67AE8584CAA73B>;
using philox4x64_w15 =
    oneapi::dpl::philox_engine<std::uint_fast64_t, 15, 4, 10, 0xCA5A826395121157, 0x9E3779B97F4A7C15,
                                             0xD2E7470EE14C6C93, 0xBB67AE8584CAA73B>;
using philox4x64_w18 =
    oneapi::dpl::philox_engine<std::uint_fast64_t, 18, 4, 10, 0xCA5A826395121157, 0x9E3779B97F4A7C15,
                                             0xD2E7470EE14C6C93, 0xBB67AE8584CAA73B>;
using philox4x64_w25 =
    oneapi::dpl::philox_engine<std::uint_fast64_t, 25, 4, 10, 0xCA5A826395121157, 0x9E3779B97F4A7C15,
                                             0xD2E7470EE14C6C93, 0xBB67AE8584CAA73B>;
using philox4x64_w49 =
    oneapi::dpl::philox_engine<std::uint_fast64_t, 49, 4, 10, 0xCA5A826395121157, 0x9E3779B97F4A7C15,
                                             0xD2E7470EE14C6C93, 0xBB67AE8584CAA73B>;
...
main()
{
    ...
    err += seed_test<oneapi::dpl::philox4x32>();
    std::cout << "void seed_test() [Engine = philox4x64]";
    err += seed_test<oneapi::dpl::philox4x64>();
    ...
    err += discard_test<oneapi::dpl::philox4x32>();
    std::cout << "void discard_test() [Engine = philox4x64]";
    err += discard_test<oneapi::dpl::philox4x64>();

    std::cout << "void set_counter_conformance_test() [Engine = philox4x32]";
    err += set_counter_conformance_test<oneapi::dpl::philox4x32>();
    std::cout << "void set_counter_conformance_test() [Engine = philox4x64]";
    err += set_counter_conformance_test<oneapi::dpl::philox4x64>();
    ...
    err += skip_test<oneapi::dpl::philox4x32>();
    std::cout << "void skip_test() [Engine = philox4x64]";
    err += skip_test<oneapi::dpl::philox4x64>();
    ...
    err += counter_overflow_test<oneapi::dpl::philox4x32>();
    std::cout << "void counter_overflow_test() [Engine = philox4x64]";
    err += counter_overflow_test<oneapi::dpl::philox4x64>();
    ...
    err += discard_overflow_test<oneapi::dpl::philox4x32>();
    std::cout << "void discard_overflow_test() [Engine = philox4x64]";
    err += discard_overflow_test<oneapi::dpl::philox4x64>();
...
set_counter_conformance_test()
{
    ...
    if (std::is_same_v<Engine, oneapi::dpl::philox4x32>)
    {
